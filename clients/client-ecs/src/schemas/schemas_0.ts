...
export var ECSServiceException$: StaticErrorSchema = [-3, _s, "ECSServiceException", 0, [], []];
...
export var BlockedException$: StaticErrorSchema = [-3, n0, _BE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var NamespaceNotFoundException$: StaticErrorSchema = [-3, n0, _NNFE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(NamespaceNotFoundException$, NamespaceNotFoundException);
export var NoUpdateAvailableException$: StaticErrorSchema = [-3, n0, _NUAE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var PlatformUnknownException$: StaticErrorSchema = [-3, n0, _PUE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var ServiceDeploymentNotFoundException$: StaticErrorSchema = [-3, n0, _SDNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var ServiceNotFoundException$: StaticErrorSchema = [-3, n0, _SNFE,
  { [_e]: _c },
  [_m],
  [0]
];
n0_registry.registerError(ServiceNotFoundException$, ServiceNotFoundException);
export var TargetNotConnectedException$: StaticErrorSchema = [-3, n0, _TNCE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var TaskSetNotFoundException$: StaticErrorSchema = [-3, n0, _TSNFE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var UpdateInProgressException$: StaticErrorSchema = [-3, n0, _UIPE,
  { [_e]: _c },
  [_m],
  [0]
];
...
export var CanaryConfiguration$: StaticStructureSchema = [3, n0, _CC,
  0,
  [_cP, _cBTIM],
  [1, 1]
];
...
export var ClusterServiceConnectDefaults$: StaticStructureSchema = [3, n0, _CSCD,
  0,
  [_na],
  [0]
];
...
export var ContainerInstance$: StaticStructureSchema = [3, n0, _CIo,
  0,
...
export var ContainerInstanceHealthStatus$: StaticStructureSchema = [3, n0, _CIHS,
  0,
  [_oS, _d],
...
export var DescribeCapacityProvidersResponse$: StaticStructureSchema = [3, n0, _DCPResc,
  0,
  [_cPap, _fa, _nT],
  [[() => CapacityProviders, 0], () => Failures, 0]
];
export var DescribeClustersRequest$: StaticStructureSchema = [3, n0, _DCRes,
  0,
  [_clu, _inc],
  [64 | 0, 64 | 0]
];
export var DescribeClustersResponse$: StaticStructureSchema = [3, n0, _DCResc,
  0,
  [_clu, _fa],
  [() => Clusters, () => Failures]
];
...
export var DockerVolumeConfiguration$: StaticStructureSchema = [3, n0, _DVC,
  0,
...
export var ExecuteCommandLogConfiguration$: StaticStructureSchema = [3, n0, _ECLC,
  0,
...
export var ExpressGatewayScalingTarget$: StaticStructureSchema = [3, n0, _EGST,
  0,
...
export var ExpressGatewayServiceStatus$: StaticStructureSchema = [3, n0, _EGSS,
  0,
  [_sCt, _sR],
  [0, 0]
];
...
export var KernelCapabilities$: StaticStructureSchema = [3, n0, _KC,
  0,
  [_ad, _dro],
  [64 | 0, 64 | 0]
];
...
export var LinearConfiguration$: StaticStructureSchema = [3, n0, _LC,
  0,
  [_sPt, _sBTIM],
  [1, 1]
];
...
export var ListAccountSettingsResponse$: StaticStructureSchema = [3, n0, _LASRi,
  0,
  [_set, _nT],
  [() => Settings, 0]
];
...
export var ListContainerInstancesRequest$: StaticStructureSchema = [3, n0, _LCIR,
  0,
  [_cl, _fi, _nT, _mRa, _st],
  [0, 0, 0, 1, 0]
];
export var ListContainerInstancesResponse$: StaticStructureSchema = [3, n0, _LCIRi,
  0,
  [_cIAo, _nT],
  [64 | 0, 0]
];
...
export var ListTaskDefinitionFamiliesRequest$: StaticStructureSchema = [3, n0, _LTDFR,
  0,
  [_fP, _st, _nT, _mRa],
  [0, 0, 0, 1]
];
export var ListTaskDefinitionFamiliesResponse$: StaticStructureSchema = [3, n0, _LTDFRi,
  0,
  [_fam, _nT],
  [64 | 0, 0]
];
export var ListTaskDefinitionsRequest$: StaticStructureSchema = [3, n0, _LTDR,
  0,
...
export var PlacementConstraint$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_t, _ex],
  [0, 0]
];
...
export var RegisterContainerInstanceRequest$: StaticStructureSchema = [3, n0, _RCIR,
  0,
...
export var ServiceEvent$: StaticStructureSchema = [3, n0, _SEe,
  0,
  [_i, _cAr, _m],
  [0, 4, 0]
];
...
export var ServiceRegistry$: StaticStructureSchema = [3, n0, _SR,
  0,
...
export var Setting$: StaticStructureSchema = [3, n0, _Set,
  0,
  [_n, _v, _pA, _t],
  [0, 0, 0, 0]
];
...
export var TaskEphemeralStorage$: StaticStructureSchema = [3, n0, _TES,
  0,
  [_sIGB, _kKI],
  [1, 0]
];
...
var AcceleratorNameSet: StaticListSchema = [1, n0, _ANS,
  0, [0,
    { [_xN]: _it }]
];
var AcceleratorTypeSet: StaticListSchema = [1, n0, _ATS,
  0, [0,
    { [_xN]: _it }]
];
var AllowedInstanceTypeSet: StaticListSchema = [1, n0, _AITS,
  0, [0,
    { [_xN]: _it }]
];
var AttachmentDetails: StaticListSchema = [1, n0, _AD,
  0, () => KeyValuePair$
];
var Attachments: StaticListSchema = [1, n0, _Att,
  0, () => Attachment$
];
var AttachmentStateChanges: StaticListSchema = [1, n0, _ASCt,
  0, () => AttachmentStateChange$
];
var Attributes: StaticListSchema = [1, n0, _Attr,
  0, () => Attribute$
];
var CapacityProviderFieldList = 64 | 0;
var CapacityProviders: StaticListSchema = [1, n0, _CPa,
  0, [() => CapacityProvider$,
    0]
];
...
var Clusters: StaticListSchema = [1, n0, _Cl,
  0, () => Cluster$
];
var ClusterSettings: StaticListSchema = [1, n0, _CSl,
  0, () => ClusterSetting$
];
...
var ContainerImages: StaticListSchema = [1, n0, _CIon,
  0, () => ContainerImage$
];
var ContainerInstanceFieldList = 64 | 0;
var ContainerInstances: StaticListSchema = [1, n0, _CIont,
  0, () => ContainerInstance$
];
...
var ContainerStateChanges: StaticListSchema = [1, n0, _CSCo,
...
var EBSTagSpecifications: StaticListSchema = [1, n0, _EBSTSa,
  0, () => EBSTagSpecification$
];
var EnvironmentFiles: StaticListSchema = [1, n0, _EFn,
  0, () => EnvironmentFile$
];
...
var GpuIds = 64 | 0;
var HostEntryList: StaticListSchema = [1, n0, _HEL,
  0, () => HostEntry$
];
var InferenceAcceleratorOverrides: StaticListSchema = [1, n0, _IAOn,
  0, () => InferenceAcceleratorOverride$
];
var InferenceAccelerators: StaticListSchema = [1, n0, _IAn,
  0, () => InferenceAccelerator$
];
var IngressPathSummaries: StaticListSchema = [1, n0, _IPSn,
  0, () => IngressPathSummary$
];
var InstanceGenerationSet: StaticListSchema = [1, n0, _IGS,
  0, [0,
    { [_xN]: _it }]
];
var InstanceHealthCheckResultList: StaticListSchema = [1, n0, _IHCRL,
  0, () => InstanceHealthCheckResult$
];
var IntegerList = 64 | 1;
var LoadBalancers: StaticListSchema = [1, n0, _LBo,
  0, () => LoadBalancer$
];
var LocalStorageTypeSet: StaticListSchema = [1, n0, _LSTS,
  0, [0,
    { [_xN]: _it }]
];
var ManagedAgents: StaticListSchema = [1, n0, _MAa,
  0, () => ManagedAgent$
];
var ManagedAgentStateChanges: StaticListSchema = [1, n0, _MASCa,
  0, () => ManagedAgentStateChange$
];
var ManagedApplicationAutoScalingPolicies: StaticListSchema = [1, n0, _MAASPa,
  0, () => ManagedApplicationAutoScalingPolicy$
];
var ManagedIngressPaths: StaticListSchema = [1, n0, _MIPan,
  0, () => ManagedIngressPath$
];
var ManagedLogGroups: StaticListSchema = [1, n0, _MLGa,
  0, () => ManagedLogGroup$
];
var ManagedMetricAlarms: StaticListSchema = [1, n0, _MMAa,
  0, () => ManagedMetricAlarm$
];
var ManagedSecurityGroups: StaticListSchema = [1, n0, _MSGa,
...
var NetworkBindings: StaticListSchema = [1, n0, _NBe,
  0, () => NetworkBinding$
];
...
var PlatformDevices: StaticListSchema = [1, n0, _PDl,
  0, () => PlatformDevice$
];
var PortMappingList: StaticListSchema = [1, n0, _PML,
  0, () => PortMapping$
];
var ProtectedTasks: StaticListSchema = [1, n0, _PTr,
  0, () => ProtectedTask$
];
var ProxyConfigurationProperties: StaticListSchema = [1, n0, _PCP,
  0, () => KeyValuePair$
];
var RequiresAttributes: StaticListSchema = [1, n0, _RA,
  0, () => Attribute$
];
...
var ServiceConnectClientAliasList: StaticListSchema = [1, n0, _SCCAL,
  0, () => ServiceConnectClientAlias$
];
var ServiceConnectServiceList: StaticListSchema = [1, n0, _SCSL,
  0, () => ServiceConnectService$
];
var ServiceConnectServiceResourceList: StaticListSchema = [1, n0, _SCSRL,
  0, () => ServiceConnectServiceResource$
];
var ServiceCurrentRevisionSummaryList: StaticListSchema = [1, n0, _SCRSL,
  0, () => ServiceCurrentRevisionSummary$
];
var ServiceDeployments: StaticListSchema = [1, n0, _SDe,
  0, () => ServiceDeployment$
];
var ServiceDeploymentsBrief: StaticListSchema = [1, n0, _SDBe,
  0, () => ServiceDeploymentBrief$
];
var ServiceDeploymentStatusList = 64 | 0;
var ServiceEvents: StaticListSchema = [1, n0, _SEer,
  0, () => ServiceEvent$
];
var ServiceFieldList = 64 | 0;
var ServiceRegistries: StaticListSchema = [1, n0, _SRer,
  0, () => ServiceRegistry$
];
var ServiceRevisionLoadBalancers: StaticListSchema = [1, n0, _SRLBe,
  0, () => ServiceRevisionLoadBalancer$
];
var ServiceRevisions: StaticListSchema = [1, n0, _SRerv,
  0, () => ServiceRevision$
];
...
var ServiceVolumeConfigurations: StaticListSchema = [1, n0, _SVCe,
  0, () => ServiceVolumeConfiguration$
];
var Settings: StaticListSchema = [1, n0, _Sett,
  0, () => Setting$
];
var Statistics: StaticListSchema = [1, n0, _St,
  0, () => KeyValuePair$
];
var StringList = 64 | 0;
var SystemControls: StaticListSchema = [1, n0, _SCy,
  0, () => SystemControl$
];
var TagKeys = 64 | 0;
var Tags: StaticListSchema = [1, n0, _Tag,
  0, () => Tag$
];
...
var TaskVolumeConfigurations: StaticListSchema = [1, n0, _TVCa,
  0, () => TaskVolumeConfiguration$
];
var TmpfsList: StaticListSchema = [1, n0, _TL,
  0, () => Tmpfs$
];
var UlimitList: StaticListSchema = [1, n0, _UL,
  0, () => Ulimit$
];
var VolumeFromList: StaticListSchema = [1, n0, _VFL,
  0, () => VolumeFrom$
];
var VolumeList: StaticListSchema = [1, n0, _VL,
  0, () => Volume$
];
var VpcLatticeConfigurations: StaticListSchema = [1, n0, _VLCp,
...
export var CreateTaskSet$: StaticOperationSchema = [9, n0, _CTS,
  0, () => CreateTaskSetRequest$, () => CreateTaskSetResponse$
];
export var DeleteAccountSetting$: StaticOperationSchema = [9, n0, _DAS,
...
export var DescribeServiceDeployments$: StaticOperationSchema = [9, n0, _DSD,
...
export var DescribeTasks$: StaticOperationSchema = [9, n0, _DT,
  0, () => DescribeTasksRequest$, () => DescribeTasksResponse$
];
export var DescribeTaskSets$: StaticOperationSchema = [9, n0, _DTSe,
  0, () => DescribeTaskSetsRequest$, () => DescribeTaskSetsResponse$
];
export var DiscoverPollEndpoint$: StaticOperationSchema = [9, n0, _DPE,
  0, () => DiscoverPollEndpointRequest$, () => DiscoverPollEndpointResponse$
];
export var ExecuteCommand$: StaticOperationSchema = [9, n0, _EC,
  0, () => ExecuteCommandRequest$, () => ExecuteCommandResponse$
];
export var GetTaskProtection$: StaticOperationSchema = [9, n0, _GTP,
  0, () => GetTaskProtectionRequest$, () => GetTaskProtectionResponse$
];
export var ListAccountSettings$: StaticOperationSchema = [9, n0, _LAS,
  0, () => ListAccountSettingsRequest$, () => ListAccountSettingsResponse$
];
export var ListAttributes$: StaticOperationSchema = [9, n0, _LA,
...
export var ListServicesByNamespace$: StaticOperationSchema = [9, n0, _LSBN,
  0, () => ListServicesByNamespaceRequest$, () => ListServicesByNamespaceResponse$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  0, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListTaskDefinitionFamilies$: StaticOperationSchema = [9, n0, _LTDF,
  0, () => ListTaskDefinitionFamiliesRequest$, () => ListTaskDefinitionFamiliesResponse$
];
export var ListTaskDefinitions$: StaticOperationSchema = [9, n0, _LTD,
...
export var PutAccountSetting$: StaticOperationSchema = [9, n0, _PAS,
  0, () => PutAccountSettingRequest$, () => PutAccountSettingResponse$
];
export var PutAccountSettingDefault$: StaticOperationSchema = [9, n0, _PASD,
  0, () => PutAccountSettingDefaultRequest$, () => PutAccountSettingDefaultResponse$
];
export var PutAttributes$: StaticOperationSchema = [9, n0, _PA,
  0, () => PutAttributesRequest$, () => PutAttributesResponse$
];
export var PutClusterCapacityProviders$: StaticOperationSchema = [9, n0, _PCCP,
...
export var RunTask$: StaticOperationSchema = [9, n0, _RT,
  0, () => RunTaskRequest$, () => RunTaskResponse$
];
export var StartTask$: StaticOperationSchema = [9, n0, _ST,
  0, () => StartTaskRequest$, () => StartTaskResponse$
];
export var StopServiceDeployment$: StaticOperationSchema = [9, n0, _SSD,
  0, () => StopServiceDeploymentRequest$, () => StopServiceDeploymentResponse$
];
export var StopTask$: StaticOperationSchema = [9, n0, _STt,
  0, () => StopTaskRequest$, () => StopTaskResponse$
];
export var SubmitAttachmentStateChanges$: StaticOperationSchema = [9, n0, _SASC,
  0, () => SubmitAttachmentStateChangesRequest$, () => SubmitAttachmentStateChangesResponse$
];
export var SubmitContainerStateChange$: StaticOperationSchema = [9, n0, _SCSC,
  0, () => SubmitContainerStateChangeRequest$, () => SubmitContainerStateChangeResponse$
];
export var SubmitTaskStateChange$: StaticOperationSchema = [9, n0, _STSC,
...
export var UpdateClusterSettings$: StaticOperationSchema = [9, n0, _UCS,
  0, () => UpdateClusterSettingsRequest$, () => UpdateClusterSettingsResponse$
];
export var UpdateContainerAgent$: StaticOperationSchema = [9, n0, _UCA,
...
export var UpdateServicePrimaryTaskSet$: StaticOperationSchema = [9, n0, _USPTS,
  0, () => UpdateServicePrimaryTaskSetRequest$, () => UpdateServicePrimaryTaskSetResponse$
];
export var UpdateTaskProtection$: StaticOperationSchema = [9, n0, _UTP,
  0, () => UpdateTaskProtectionRequest$, () => UpdateTaskProtectionResponse$
];
export var UpdateTaskSet$: StaticOperationSchema = [9, n0, _UTS,
