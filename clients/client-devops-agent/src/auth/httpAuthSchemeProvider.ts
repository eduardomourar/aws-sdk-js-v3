...
import { type DevOpsAgentClientResolvedConfig, DevOpsAgentClientConfig } from "../DevOpsAgentClient";
 ...
 * @internal
 */
export const defaultDevOpsAgentHttpAuthSchemeParametersProvider = async (
...
function createAwsAuthSigv4HttpAuthOption(authParameters: DevOpsAgentHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<DevOpsAgentClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultDevOpsAgentHttpAuthSchemeProvider: DevOpsAgentHttpAuthSchemeProvider = (authParameters) => {
