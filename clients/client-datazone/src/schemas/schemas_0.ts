...
const _ACP = "AuthenticationConfigurationPatch";
const _ACPu = "AuthorizationCodeProperties";
const _ACc = "AcceptChoices";
...
const _AGT = "AssociateGovernedTerms";
const _AGTI = "AssociateGovernedTermsInput";
const _AGTO = "AssociateGovernedTermsOutput";
const _AI = "AccountInfo";
const _AIAA = "AssetItemAdditionalAttributes";
const _AIDPLI = "AssetInDataProductListingItem";
...
const _ALIAA = "AssetListingItemAdditionalAttributes";
const _ALIs = "AssetListingItem";
const _ALg = "AggregationList";
const _ALs = "AssetListing";
const _ALw = "AwsLocation";
const _AN = "AssetName";
const _AO = "AggregationOutput";
...
const _API = "AcceptPredictionsInput";
const _APIt = "AthenaPropertiesInput";
const _APN = "AccountPoolName";
const _APO = "AcceptPredictionsOutput";
const _APOt = "AthenaPropertiesOutput";
...
const _ARs = "AssetRevision";
const _ARss = "AssetRevisions";
const _AS = "AssetScope";
const _ASR = "AcceptSubscriptionRequest";
const _ASRI = "AcceptSubscriptionRequestInput";
const _ASRO = "AcceptSubscriptionRequestOutput";
const _ASc = "AccountSource";
const _ATFR = "AssetTypesForRule";
const _ATI = "AssetTypeItem";
const _ATN = "AssetTargetNames";
const _ATNM = "AssetTargetNameMap";
...
const _CAFO = "CreateAssetFilterOutput";
const _CAI = "CreateAssetInput";
const _CAO = "CreateAssetOutput";
const _CAP = "ConfigurableActionParameter";
const _CAPH = "CustomAccountPoolHandler";
const _CAPI = "CreateAccountPoolInput";
const _CAPL = "ConfigurableActionParameterList";
const _CAPO = "CreateAccountPoolOutput";
const _CAPr = "CreateAccountPool";
const _CAR = "CreateAssetRevision";
const _CARI = "CreateAssetRevisionInput";
const _CARO = "CreateAssetRevisionOutput";
const _CAT = "CreateAssetType";
const _CATI = "CreateAssetTypeInput";
const _CATO = "CreateAssetTypeOutput";
...
const _CDP = "CreateDataProduct";
const _CDPI = "CreateDataProductInput";
const _CDPO = "CreateDataProductOutput";
const _CDPR = "CreateDataProductRevision";
const _CDPRI = "CreateDataProductRevisionInput";
const _CDPRO = "CreateDataProductRevisionOutput";
const _CDS = "CreateDataSource";
const _CDSI = "CreateDataSourceInput";
const _CDSO = "CreateDataSourceOutput";
const _CDU = "CreateDomainUnit";
const _CDUI = "CreateDomainUnitInput";
const _CDUO = "CreateDomainUnitOutput";
const _CDUPGD = "CreateDomainUnitPolicyGrantDetail";
const _CE = "ConflictException";
const _CEA = "ConfigurableEnvironmentAction";
const _CEAI = "CreateEnvironmentActionInput";
const _CEAO = "CreateEnvironmentActionOutput";
const _CEAr = "CreateEnvironmentAction";
const _CEB = "CreateEnvironmentBlueprint";
const _CEBI = "CreateEnvironmentBlueprintInput";
const _CEBO = "CreateEnvironmentBlueprintOutput";
const _CEI = "CreateEnvironmentInput";
const _CEO = "CreateEnvironmentOutput";
const _CEP = "CreateEnvironmentProfile";
const _CEPI = "CreateEnvironmentProfileInput";
const _CEPO = "CreateEnvironmentProfileOutput";
const _CEPPGD = "CreateEnvironmentProfilePolicyGrantDetail";
const _CEr = "CreateEnvironment";
const _CFC = "ColumnFilterConfiguration";
const _CFP = "CloudFormationProperties";
const _CFT = "CreateFormType";
const _CFTI = "CreateFormTypeInput";
const _CFTO = "CreateFormTypeOutput";
const _CFTPGD = "CreateFormTypePolicyGrantDetail";
const _CG = "CreateGlossary";
const _CGI = "CreateGlossaryInput";
const _CGO = "CreateGlossaryOutput";
const _CGP = "CreateGroupProfile";
const _CGPGD = "CreateGlossaryPolicyGrantDetail";
const _CGPI = "CreateGroupProfileInput";
const _CGPO = "CreateGroupProfileOutput";
...
const _CPL = "CustomParameterList";
const _CPM = "CreateProjectMembership";
const _CPMI = "CreateProjectMembershipInput";
...
const _CSG = "CreateSubscriptionGrant";
const _CSGI = "CreateSubscriptionGrantInput";
const _CSGO = "CreateSubscriptionGrantOutput";
const _CSI = "CancelSubscriptionInput";
const _CSO = "CancelSubscriptionOutput";
const _CSR = "CreateSubscriptionRequest";
const _CSRI = "CreateSubscriptionRequestInput";
const _CSRO = "CreateSubscriptionRequestOutput";
const _CST = "CreateSubscriptionTarget";
const _CSTI = "CreateSubscriptionTargetInput";
const _CSTO = "CreateSubscriptionTargetOutput";
...
const _DAFI = "DeleteAssetFilterInput";
const _DAI = "DeleteAssetInput";
const _DAO = "DeleteAssetOutput";
const _DAP = "DeleteAccountPool";
const _DAPI = "DeleteAccountPoolInput";
const _DAPO = "DeleteAccountPoolOutput";
const _DAT = "DeleteAssetType";
const _DATI = "DeleteAssetTypeInput";
const _DATO = "DeleteAssetTypeOutput";
...
const _DDPI = "DeleteDataProductInput";
const _DDPO = "DeleteDataProductOutput";
const _DDS = "DeleteDataSource";
const _DDSI = "DeleteDataSourceInput";
const _DDSO = "DeleteDataSourceOutput";
const _DDU = "DeleteDomainUnit";
const _DDUI = "DeleteDomainUnitInput";
const _DDUO = "DeleteDomainUnitOutput";
const _DDe = "DeleteDomain";
const _DE = "DeleteEnvironment";
const _DEA = "DeleteEnvironmentAction";
const _DEAI = "DeleteEnvironmentActionInput";
const _DEB = "DeleteEnvironmentBlueprint";
const _DEBC = "DeleteEnvironmentBlueprintConfiguration";
const _DEBCI = "DeleteEnvironmentBlueprintConfigurationInput";
const _DEBCO = "DeleteEnvironmentBlueprintConfigurationOutput";
const _DEBI = "DeleteEnvironmentBlueprintInput";
const _DEI = "DeleteEnvironmentInput";
const _DEP = "DeleteEnvironmentProfile";
const _DEPI = "DeleteEnvironmentProfileInput";
const _DER = "DisassociateEnvironmentRole";
const _DERI = "DisassociateEnvironmentRoleInput";
const _DERO = "DisassociateEnvironmentRoleOutput";
const _DFT = "DeleteFormType";
const _DFTI = "DeleteFormTypeInput";
const _DFTO = "DeleteFormTypeOutput";
const _DG = "DeleteGlossary";
const _DGI = "DeleteGlossaryInput";
const _DGO = "DeleteGlossaryOutput";
const _DGT = "DetailedGlossaryTerm";
const _DGTI = "DeleteGlossaryTermInput";
const _DGTIi = "DisassociateGovernedTermsInput";
const _DGTO = "DeleteGlossaryTermOutput";
const _DGTOi = "DisassociateGovernedTermsOutput";
const _DGTe = "DetailedGlossaryTerms";
const _DGTel = "DeleteGlossaryTerm";
...
const _DPIa = "DataProductItems";
const _DPIe = "DeleteProjectInput";
const _DPL = "DataProductListing";
const _DPLI = "DataProductListingItem";
const _DPLIAA = "DataProductListingItemAdditionalAttributes";
const _DPM = "DeleteProjectMembership";
const _DPMI = "DeleteProjectMembershipInput";
const _DPMO = "DeleteProjectMembershipOutput";
const _DPN = "DataProductName";
const _DPO = "DeleteProjectOutput";
const _DPP = "DeleteProjectProfile";
const _DPPI = "DeleteProjectProfileInput";
const _DPPO = "DeleteProjectProfileOutput";
...
const _DSCI = "DataSourceConfigurationInput";
const _DSCO = "DataSourceConfigurationOutput";
const _DSEM = "DataSourceErrorMessage";
const _DSG = "DeleteSubscriptionGrant";
const _DSGI = "DeleteSubscriptionGrantInput";
const _DSGO = "DeleteSubscriptionGrantOutput";
const _DSR = "DeleteSubscriptionRequest";
const _DSRA = "DataSourceRunActivity";
const _DSRAa = "DataSourceRunActivities";
const _DSRI = "DeleteSubscriptionRequestInput";
const _DSRLS = "DataSourceRunLineageSummary";
const _DSRS = "DataSourceRunSummary";
const _DSRSa = "DataSourceRunSummaries";
const _DSS = "DataSourceSummary";
const _DSSa = "DataSourceSummaries";
const _DST = "DeleteSubscriptionTarget";
const _DSTI = "DeleteSubscriptionTargetInput";
const _DSo = "DomainSummaries";
const _DTSDP = "DeleteTimeSeriesDataPoints";
const _DTSDPI = "DeleteTimeSeriesDataPointsInput";
const _DTSDPO = "DeleteTimeSeriesDataPointsOutput";
const _DUD = "DomainUnitDescription";
const _DUFFP = "DomainUnitFilterForProject";
const _DUGF = "DomainUnitGrantFilter";
const _DUGP = "DomainUnitGroupProperties";
const _DUN = "DomainUnitName";
const _DUO = "DomainUnitOwners";
const _DUOP = "DomainUnitOwnerProperties";
const _DUPGP = "DomainUnitPolicyGrantPrincipal";
const _DUS = "DomainUnitSummary";
const _DUSo = "DomainUnitSummaries";
const _DUT = "DomainUnitTarget";
const _DUUP = "DomainUnitUserProperties";
const _De = "Deployment";
const _EAL = "EnvironmentActionList";
const _EAS = "EnvironmentActionSummary";
const _EBC = "EnvironmentBlueprintConfigurations";
...
const _ECP = "EnvironmentConfigurationParameter";
const _ECPD = "EnvironmentConfigurationParametersDetails";
...
const _ESv = "EventSummary";
const _ET = "Event-Time";
const _ETE = "EqualToExpression";
const _EV = "EditedValue";
const _F = "Filter";
const _FC = "FailureCause";
const _FCi = "FilterClause";
const _FE = "FilterExpression";
const _FEI = "FormEntryInput";
const _FEO = "FormEntryOutput";
const _FEi = "FilterExpressions";
const _FI = "FormInput";
const _FIL = "FormInputList";
const _FIM = "FormsInputMap";
...
const _GA = "GetAsset";
const _GAF = "GetAssetFilter";
const _GAFI = "GetAssetFilterInput";
const _GAFO = "GetAssetFilterOutput";
const _GAI = "GetAssetInput";
const _GAO = "GetAssetOutput";
const _GAP = "GetAccountPool";
const _GAPI = "GetAccountPoolInput";
const _GAPO = "GetAccountPoolOutput";
...
const _GDPI = "GetDataProductInput";
const _GDPO = "GetDataProductOutput";
const _GDS = "GetDataSource";
const _GDSI = "GetDataSourceInput";
const _GDSO = "GetDataSourceOutput";
const _GDSR = "GetDataSourceRun";
const _GDSRI = "GetDataSourceRunInput";
const _GDSRO = "GetDataSourceRunOutput";
const _GDU = "GetDomainUnit";
const _GDUI = "GetDomainUnitInput";
const _GDUO = "GetDomainUnitOutput";
const _GDe = "GetDomain";
const _GDr = "GroupDetails";
const _GE = "GrantedEntity";
const _GEA = "GetEnvironmentAction";
const _GEAI = "GetEnvironmentActionInput";
const _GEAO = "GetEnvironmentActionOutput";
const _GEB = "GetEnvironmentBlueprint";
const _GEBC = "GetEnvironmentBlueprintConfiguration";
const _GEBCI = "GetEnvironmentBlueprintConfigurationInput";
const _GEBCO = "GetEnvironmentBlueprintConfigurationOutput";
const _GEBI = "GetEnvironmentBlueprintInput";
const _GEBO = "GetEnvironmentBlueprintOutput";
const _GEC = "GetEnvironmentCredentials";
const _GECI = "GetEnvironmentCredentialsInput";
const _GECO = "GetEnvironmentCredentialsOutput";
const _GEI = "GetEnvironmentInput";
const _GEIr = "GrantedEntityInput";
const _GEO = "GetEnvironmentOutput";
const _GEP = "GetEnvironmentProfile";
const _GEPI = "GetEnvironmentProfileInput";
const _GEPO = "GetEnvironmentProfileOutput";
const _GEe = "GetEnvironment";
const _GFT = "GetFormType";
const _GFTI = "GetFormTypeInput";
const _GFTO = "GetFormTypeOutput";
const _GG = "GetGlossary";
const _GGI = "GetGlossaryInput";
const _GGO = "GetGlossaryOutput";
const _GGP = "GetGroupProfile";
const _GGPI = "GetGroupProfileInput";
const _GGPO = "GetGroupProfileOutput";
const _GGT = "GetGlossaryTerm";
const _GGTI = "GetGlossaryTermInput";
const _GGTO = "GetGlossaryTermOutput";
const _GI = "GlossaryItem";
const _GIAA = "GlossaryItemAdditionalAttributes";
const _GIPLU = "GetIamPortalLoginUrl";
const _GIPLUI = "GetIamPortalLoginUrlInput";
const _GIPLUO = "GetIamPortalLoginUrlOutput";
const _GJR = "GetJobRun";
const _GJRI = "GetJobRunInput";
const _GJRO = "GetJobRunOutput";
const _GL = "GetListing";
const _GLE = "GetLineageEvent";
const _GLEI = "GetLineageEventInput";
const _GLEO = "GetLineageEventOutput";
const _GLI = "GetListingInput";
const _GLN = "GetLineageNode";
...
const _GSGO = "GetSubscriptionGrantOutput";
const _GSGSO = "GlueSelfGrantStatusOutput";
const _GSI = "GetSubscriptionInput";
const _GSO = "GetSubscriptionOutput";
const _GSRD = "GetSubscriptionRequestDetails";
const _GSRDI = "GetSubscriptionRequestDetailsInput";
const _GSRDO = "GetSubscriptionRequestDetailsOutput";
const _GST = "GroupSearchText";
const _GSTI = "GetSubscriptionTargetInput";
...
const _GTOETE = "GreaterThanOrEqualToExpression";
const _GTSDP = "GetTimeSeriesDataPoint";
const _GTSDPI = "GetTimeSeriesDataPointInput";
const _GTSDPO = "GetTimeSeriesDataPointOutput";
const _GUP = "GetUserProfile";
const _GUPI = "GetUserProfileInput";
const _GUPO = "GetUserProfileOutput";
const _HPPI = "HyperPodPropertiesInput";
const _HPPO = "HyperPodPropertiesOutput";
const _I = "Id";
...
const _IPO = "IamPropertiesOutput";
const _IPP = "IamPropertiesPatch";
const _ISE = "InternalServerException";
const _IUPD = "IamUserProfileDetails";
const _Im = "Import";
const _JRD = "JobRunDetails";
const _JRE = "JobRunError";
const _JRS = "JobRunSummary";
const _JRSo = "JobRunSummaries";
const _LAF = "ListAssetFilters";
const _LAFI = "ListAssetFiltersInput";
const _LAFO = "ListAssetFiltersOutput";
const _LAIAP = "ListAccountsInAccountPool";
const _LAIAPI = "ListAccountsInAccountPoolInput";
const _LAIAPO = "ListAccountsInAccountPoolOutput";
const _LAP = "ListAccountPools";
const _LAPI = "ListAccountPoolsInput";
const _LAPO = "ListAccountPoolsOutput";
const _LAR = "ListAssetRevisions";
const _LARI = "ListAssetRevisionsInput";
const _LARO = "ListAssetRevisionsOutput";
...
const _LDPR = "ListDataProductRevisions";
const _LDPRI = "ListDataProductRevisionsInput";
const _LDPRO = "ListDataProductRevisionsOutput";
const _LDS = "ListDataSources";
const _LDSI = "ListDataSourcesInput";
const _LDSO = "ListDataSourcesOutput";
const _LDSR = "ListDataSourceRuns";
const _LDSRA = "ListDataSourceRunActivities";
const _LDSRAI = "ListDataSourceRunActivitiesInput";
const _LDSRAO = "ListDataSourceRunActivitiesOutput";
const _LDSRI = "ListDataSourceRunsInput";
const _LDSRO = "ListDataSourceRunsOutput";
const _LDUFP = "ListDomainUnitsForParent";
const _LDUFPI = "ListDomainUnitsForParentInput";
const _LDUFPO = "ListDomainUnitsForParentOutput";
const _LDi = "ListDomains";
const _LE = "LineageEvent";
const _LEA = "ListEnvironmentActions";
const _LEAI = "ListEnvironmentActionsInput";
const _LEAO = "ListEnvironmentActionsOutput";
const _LEAS = "ListEnvironmentActionSummaries";
const _LEB = "ListEnvironmentBlueprints";
const _LEBC = "ListEnvironmentBlueprintConfigurations";
const _LEBCI = "ListEnvironmentBlueprintConfigurationsInput";
const _LEBCO = "ListEnvironmentBlueprintConfigurationsOutput";
const _LEBI = "ListEnvironmentBlueprintsInput";
const _LEBO = "ListEnvironmentBlueprintsOutput";
const _LEI = "ListEnvironmentsInput";
const _LEO = "ListEnvironmentsOutput";
const _LEOI = "ListEntityOwnersInput";
const _LEOO = "ListEntityOwnersOutput";
const _LEOi = "ListEntityOwners";
const _LEP = "ListEnvironmentProfiles";
const _LEPI = "ListEnvironmentProfilesInput";
const _LEPO = "ListEnvironmentProfilesOutput";
const _LES = "LineageEventSummary";
const _LESi = "LineageEventSummaries";
const _LEi = "LikeExpression";
const _LEis = "ListEnvironments";
const _LFC = "LakeFormationConfiguration";
const _LI = "LineageInfo";
const _LIi = "ListingItem";
const _LJR = "ListJobRuns";
const _LJRI = "ListJobRunsInput";
const _LJRO = "ListJobRunsOutput";
const _LLE = "ListLineageEvents";
const _LLEI = "ListLineageEventsInput";
const _LLEO = "ListLineageEventsOutput";
const _LLNH = "ListLineageNodeHistory";
const _LLNHI = "ListLineageNodeHistoryInput";
const _LLNHO = "ListLineageNodeHistoryOutput";
const _LMGR = "ListMetadataGenerationRuns";
...
const _LSRO = "ListSubscriptionRequestsOutput";
const _LSS = "LineageSyncSchedule";
const _LST = "ListSubscriptionTargets";
const _LSTI = "ListSubscriptionTargetsInput";
const _LSTO = "ListSubscriptionTargetsOutput";
const _LSi = "ListingSummaries";
const _LSis = "ListSubscriptions";
const _LTE = "LessThanExpression";
const _LTFR = "ListTagsForResource";
const _LTFRR = "ListTagsForResourceRequest";
const _LTFRRi = "ListTagsForResourceResponse";
const _LTOETE = "LessThanOrEqualToExpression";
const _LTSDP = "ListTimeSeriesDataPoints";
...
const _MFED = "MetadataFormEnforcementDetail";
const _MFI = "MetadataFormInputs";
const _MFR = "MetadataFormReference";
const _MFS = "MetadataFormSummary";
const _MFSe = "MetadataFormsSummary";
...
const _MPO = "MlflowPropertiesOutput";
...
const _OPOPGD = "OverrideProjectOwnersPolicyGrantDetail";
...
const _PEBCO = "PutEnvironmentBlueprintConfigurationOutput";
const _PEh = "PhysicalEndpoints";
const _PFR = "ProjectsForRule";
const _PGD = "PolicyGrantDetail";
const _PGF = "ProjectGrantFilter";
const _PGL = "PolicyGrantList";
const _PGM = "PolicyGrantMember";
const _PGP = "PolicyGrantPrincipal";
const _PLE = "PostLineageEvent";
...
const _PPGP = "ProjectPolicyGrantPrincipal";
...
const _RCS = "RedshiftClusterStorage";
...
const _REOO = "RemoveEntityOwnerOutput";
const _RF = "RowFilter";
const _RFC = "RelationalFilterConfiguration";
const _RFCe = "RelationalFilterConfigurations";
...
const _RPI = "RedshiftPropertiesInput";
const _RPIe = "RejectPredictionsInput";
const _RPM = "RegionalParameterMap";
...
const _RSGSO = "RedshiftSelfGrantStatusOutput";
const _RSI = "RevokeSubscriptionInput";
const _RSO = "RevokeSubscriptionOutput";
const _RSP = "RedshiftStorageProperties";
const _RSR = "RejectSubscriptionRequest";
const _RSRI = "RejectSubscriptionRequestInput";
const _RSRO = "RejectSubscriptionRequestOutput";
const _RSS = "RedshiftServerlessStorage";
const _RSe = "RedshiftStorage";
const _RSev = "RevokeSubscription";
const _RSu = "RuleSummary";
const _RSul = "RuleSummaries";
const _RT = "ResourceTag";
const _RTP = "ResourceTagParameter";
const _RTe = "ResourceTags";
const _RTu = "RuleTarget";
const _Re = "Region";
...
const _SGPO = "SearchGroupProfilesOutput";
const _SGPOp = "SparkGluePropertiesOutput";
const _SGS = "SubscriptionGrantSummary";
...
const _SLIu = "SubscribedListingInput";
const _SLIub = "SubscribedListingInputs";
...
const _SR = "SubscriptionRequests";
const _SRI = "SearchResultItems";
...
const _STF = "SubscriptionTargetForm";
const _STFu = "SubscriptionTargetForms";
const _STI = "SearchTypesInput";
const _STN = "SubscriptionTargetName";
const _STO = "SearchTypesOutput";
const _STRI = "SearchTypesResultItems";
...
const _SUPO = "SearchUserProfilesOutput";
const _Se = "Search";
const _T = "Title";
...
const _TSDPFOL = "TimeSeriesDataPointFormOutputList";
const _TSDPSFO = "TimeSeriesDataPointSummaryFormOutput";
const _TSDPSFOL = "TimeSeriesDataPointSummaryFormOutputList";
const _To = "Topic";
const _U = "Unit";
const _UAF = "UpdateAssetFilter";
const _UAFI = "UpdateAssetFilterInput";
const _UAFO = "UpdateAssetFilterOutput";
const _UAP = "UpdateAccountPool";
const _UAPI = "UpdateAccountPoolInput";
const _UAPO = "UpdateAccountPoolOutput";
const _UATPGD = "UseAssetTypePolicyGrantDetail";
const _UC = "UpdateConnection";
const _UCI = "UpdateConnectionInput";
const _UCO = "UpdateConnectionOutput";
const _UD = "UserDetails";
const _UDI = "UpdateDomainInput";
const _UDO = "UpdateDomainOutput";
const _UDS = "UpdateDataSource";
const _UDSI = "UpdateDataSourceInput";
const _UDSO = "UpdateDataSourceOutput";
const _UDU = "UpdateDomainUnit";
const _UDUI = "UpdateDomainUnitInput";
const _UDUO = "UpdateDomainUnitOutput";
const _UDp = "UpdateDomain";
const _UE = "UnauthorizedException";
const _UEA = "UpdateEnvironmentAction";
const _UEAI = "UpdateEnvironmentActionInput";
const _UEAO = "UpdateEnvironmentActionOutput";
const _UEB = "UpdateEnvironmentBlueprint";
const _UEBI = "UpdateEnvironmentBlueprintInput";
const _UEBO = "UpdateEnvironmentBlueprintOutput";
const _UEI = "UpdateEnvironmentInput";
const _UEO = "UpdateEnvironmentOutput";
const _UEP = "UpdateEnvironmentProfile";
const _UEPI = "UpdateEnvironmentProfileInput";
const _UEPO = "UpdateEnvironmentProfileOutput";
const _UEp = "UpdateEnvironment";
const _UG = "UpdateGlossary";
const _UGI = "UpdateGlossaryInput";
const _UGO = "UpdateGlossaryOutput";
const _UGP = "UpdateGroupProfile";
const _UGPI = "UpdateGroupProfileInput";
const _UGPO = "UpdateGroupProfileOutput";
...
const _UPP = "UpdateProjectProfile";
const _UPPI = "UpdateProjectProfileInput";
const _UPPO = "UpdateProjectProfileOutput";
const _UPS = "UserProfileSummary";
...
const _USGS = "UpdateSubscriptionGrantStatus";
const _USGSI = "UpdateSubscriptionGrantStatusInput";
const _USGSO = "UpdateSubscriptionGrantStatusOutput";
const _USR = "UpdateSubscriptionRequest";
const _USRI = "UpdateSubscriptionRequestInput";
const _USRO = "UpdateSubscriptionRequestOutput";
const _UST = "UserSearchText";
const _USTI = "UpdateSubscriptionTargetInput";
const _USTO = "UpdateSubscriptionTargetOutput";
const _USTp = "UpdateSubscriptionTarget";
...
const _WSPO = "WorkflowsServerlessPropertiesOutput";
const _a = "attribute";
const _aA = "additionalAttributes";
const _aAI = "awsAccountId";
const _aAIP = "awsAccountIdPath";
const _aAN = "awsAccountName";
const _aAR = "awsAccountRegion";
const _aAT = "applicableAssetTypes";
const _aAd = "additionalArgs";
const _aAw = "awsAccount";
const _aC = "acceptChoices";
const _aCL = "awsConsoleLink";
const _aCP = "authorizationCodeProperties";
const _aCPRT = "allowCustomProjectResourceTags";
const _aCU = "authCodeUrl";
const _aCu = "authorizationCode";
const _aCut = "authenticationConfiguration";
const _aDUGF = "allDomainUnitsGrantFilter";
const _aDUI = "ancestorDomainUnitIds";
const _aFI = "assetFormsInput";
const _aFO = "assetFormsOutput";
const _aI = "assetId";
const _aIDQR = "autoImportDataQualityResult";
...
const _aS = "assetScopes";
const _aSc = "accountSource";
const _aSs = "assetScope";
const _aT = "assetType";
const _aTI = "assetTypeItem";
const _aTN = "assetTargetNames";
const _aTPMP = "addToProjectMemberPool";
const _aTc = "accessToken";
const _aTf = "afterTimestamp";
...
const _dO = "deploymentOrder";
const _dP = "deploymentProperties";
const _dPI = "dataProductId";
const _dPIa = "dataProductItem";
const _dPL = "dataProductListing";
const _dPR = "dataProductRevision";
...
const _dSIa = "dataSourceIdentifier";
const _dSRI = "dataSourceRunId";
const _dT = "deploymentType";
const _dU = "domainUnit";
const _dUD = "domainUnitDesignation";
const _dUF = "domainUnitFilter";
const _dUGF = "domainUnitGrantFilter";
const _dUI = "domainUnitId";
const _dUIo = "domainUnitIdentifier";
const _dUT = "domainUnitTarget";
const _dV = "displayValue";
const _dVe = "defaultValue";
const _dVo = "domainVersion";
const _da = "database";
const _de = "description";
const _des = "designation";
const _det = "details";
const _di = "direction";
const _e = "error";
const _eA = "environmentActions";
const _eAI = "environmentAccountIdentifier";
const _eAR = "environmentAccountRegion";
const _eAn = "endedAt";
...
const _eIn = "entityId";
const _eInv = "environmentIdentifier";
const _eInvi = "environmentId";
const _eIv = "eventId";
const _eIx = "externalIdentifier";
const _eM = "errorMessage";
const _eMr = "errorMessages";
const _eO = "endOffset";
...
const _eRF = "effectiveRowFilter";
const _eRPB = "environmentRolePermissionBoundary";
const _eRn = "enabledRegions";
const _eS = "enableSetting";
const _eSI = "existingSubscriptionId";
const _eSv = "eventSummary";
const _eSve = "eventStatus";
const _eT = "entityType";
const _eTGTE = "eventTimestampGTE";
const _eTIP = "enableTrustedIdentityPropagation";
const _eTLTE = "eventTimestampLTE";
const _eTM = "endTimeoutMinutes";
const _eTn = "endTime";
const _eTq = "equalTo";
...
const _fRCB = "firstRevisionCreatedBy";
const _fRa = "failureReason";
const _fT = "fieldType";
const _fTI = "formTypeIdentifier";
const _fTIo = "formTypeItem";
const _fTa = "failureTimestamp";
const _fa = "failed";
const _fi = "filters";
const _fil = "filter";
const _fo = "form";
...
const _gI = "grantId";
const _gIl = "glossaryIdentifier";
const _gIlo = "glossaryId";
const _gIlos = "glossaryItem";
const _gIr = "groupIdentifier";
const _gIra = "grantIdentifier";
const _gIro = "groupId";
const _gL = "grantList";
...
const _gTr = "groupType";
const _gTra = "grantedTimestamp";
const _gTre = "greaterThan";
const _gV = "glueVersion";
const _h = "host";
const _hE = "httpError";
const _hH = "httpHeader";
const _hPP = "hyperPodProperties";
const _hQ = "httpQuery";
const _ht = "http";
const _i = "identifier";
const _iA = "isA";
const _iC = "includeCascaded";
const _iCDU = "includeChildDomainUnits";
const _iCI = "iamConnectionId";
...
const _j = "job";
const _jI = "jobId";
const _jIU = "jdbcIamUrl";
const _jIo = "jobIdentifier";
const _jT = "jobType";
const _jTw = "jwtToken";
const _jU = "jdbcUrl";
const _jVE = "javaVirtualEnv";
const _k = "key";
...
const _lRD = "lineageRunDetails";
const _lREM = "lastRunErrorMessage";
const _lRESL = "locationRegistrationExcludeS3Locations";
const _lRR = "locationRegistrationRole";
const _lRS = "lastRunStatus";
const _lS = "listingStatus";
const _lSi = "lineageSummary";
const _lSin = "lineageSync";
const _lT = "lessThan";
const _lTOET = "lessThanOrEqualTo";
const _lTSDPF = "latestTimeSeriesDataPointForms";
const _lTSDPFO = "latestTimeSeriesDataPointFormsOutput";
const _lU = "logUri";
const _lUA = "lastUpdatedAt";
const _lUB = "listingUpdatedBy";
const _lUBa = "lastUpdatedBy";
...
const _mD = "memberDetails";
const _mEA = "managedEndpointArn";
const _mEC = "managedEndpointCredentials";
const _mEN = "mwaaEnvironmentName";
const _mF = "metadataForms";
const _mFED = "metadataFormEnforcementDetail";
...
const _oPIw = "owningProjectIdentifier";
...
const _sPs = "ssmPath";
const _sPu = "subscribedPrincipal";
const _sQRD = "sqlQueryRunDetails";
...
const _sTM = "startTimeoutMinutes";
...
const _tIa = "targetIdentifier";
const _tK = "tagKeys";
const _tLTE = "timestampLTE";
const _tM = "textMatches";
const _tMC = "totalMatchCount";
const _tN = "targetName";
const _tNe = "technicalName";
const _tNy = "typeName";
...
const _uN = "userName";
const _uNp = "upstreamNodes";
const _uP = "userParameters";
const _uPI = "userProfileId";
const _uPs = "usernamePassword";
const _uR = "usageRestrictions";
const _uT = "userType";
const _un = "unchanged";
const _up = "updated";
const _us = "username";
...
const _wSP = "workflowsServerlessProperties";
...
export var DataZoneServiceException$: StaticErrorSchema = [-3, _s, "DataZoneServiceException", 0, [], []];
...
export var AddToProjectMemberPoolPolicyGrantDetail$: StaticStructureSchema = [3, n0, _ATPMPPGD,
  0,
  [_iCDU],
  [2]
];
...
export var AggregationOutputItem$: StaticStructureSchema = [3, n0, _AOI,
  0,
  [_v, _co, _dV],
  [0, 1, 0]
];
export var AllDomainUnitsGrantFilter$: StaticStructureSchema = [3, n0, _ADUGF,
  0,
  [],
  []
];
export var AllUsersGrantFilter$: StaticStructureSchema = [3, n0, _AUGF,
  0,
  [],
  []
];
...
export var AssetItemAdditionalAttributes$: StaticStructureSchema = [3, n0, _AIAA,
  ...
  [[() => FormOutputList, 0], [() => FormOutputList, 0], () => TimeSeriesDataPointSummaryFormOutputList, () => MatchRationale]
];
export var AssetListing$: StaticStructureSchema = [3, n0, _ALs,
  0,
  [_aI, _aRs, _aT, _cA, _f, _lTSDPF, _gT, _gGT, _oPI],
  [0, 0, 0, 4, 0, () => TimeSeriesDataPointSummaryFormOutputList, [() => DetailedGlossaryTerms, 0], [() => DetailedGlossaryTerms, 0], 0]
];
...
export var AssetListingItem$: StaticStructureSchema = [3, n0, _ALIs,
  ...
  [0, 0, [() => AssetName, 0], 0, 0, 0, [() => Description, 0], 4, 0, 0, [() => DetailedGlossaryTerms, 0], [() => DetailedGlossaryTerms, 0], 0, () => AssetListingItemAdditionalAttributes$]
];
export var AssetListingItemAdditionalAttributes$: StaticStructureSchema = [3, n0, _ALIAA,
  0,
  [_f, _mR, _lTSDPF],
...
export var AthenaPropertiesInput$: StaticStructureSchema = [3, n0, _APIt,
  0,
  [_wN],
  [0]
];
export var AthenaPropertiesOutput$: StaticStructureSchema = [3, n0, _APOt,
  0,
  [_wN],
  [0]
];
export var AthenaPropertiesPatch$: StaticStructureSchema = [3, n0, _APP,
  0,
  [_wN],
  [0]
];
...
export var AuthenticationConfigurationPatch$: StaticStructureSchema = [3, n0, _ACP,
  0,
  [_sA, _bAC],
  [0, [() => BasicAuthenticationCredentials$, 0]]
];
export var AuthorizationCodeProperties$: StaticStructureSchema = [3, n0, _ACPu,
  0,
  [_aCu, _rU],
  [0, 0]
];
export var AwsConsoleLinkParameters$: StaticStructureSchema = [3, n0, _ACLP,
  0,
  [_u],
  [0]
];
export var AwsLocation$: StaticStructureSchema = [3, n0, _ALw,
  0,
  [_aRc, _aAI, _aRw, _iCI],
  [0, 0, 0, 0]
];
...
export var BusinessNameGenerationConfiguration$: StaticStructureSchema = [3, n0, _BNGC,
  0,
  [_en],
  [2]
];
...
export var ConfigurableActionParameter$: StaticStructureSchema = [3, n0, _CAP,
  0,
  [_k, _v],
  [0, 0]
];
...
export var DataProductListing$: StaticStructureSchema = [3, n0, _DPL,
  0,
  [_dPI, _dPR, _cA, _f, _gT, _oPI, _it],
  [0, 0, 4, 0, [() => DetailedGlossaryTerms, 0], 0, [() => ListingSummaries, 0]]
];
export var DataProductListingItem$: StaticStructureSchema = [3, n0, _DPLI,
  0,
  [_lI, _lR, _n, _eIn, _eR, _de, _cA, _lCB, _lUB, _gT, _oPI, _aA, _it],
  [0, 0, [() => DataProductName, 0], 0, 0, [() => Description, 0], 4, 0, 0, [() => DetailedGlossaryTerms, 0], 0, () => DataProductListingItemAdditionalAttributes$, [() => ListingSummaryItems, 0]]
];
export var DataProductListingItemAdditionalAttributes$: StaticStructureSchema = [3, n0, _DPLIAA,
  0,
  [_f, _mR],
  [0, () => MatchRationale]
];
...
export var DetailedGlossaryTerm$: StaticStructureSchema = [3, n0, _DGT,
  0,
  [_n, _sD],
  [[() => GlossaryTermName, 0], [() => ShortDescription, 0]]
];
...
export var EnvironmentConfigurationParametersDetails$: StaticStructureSchema = [3, n0, _ECPD,
  0,
  [_sPs, _pO, _rPes],
  [0, () => EnvironmentConfigurationParametersList, () => EnvironmentConfigurationParametersList]
];
export var EnvironmentConfigurationUserParameter$: StaticStructureSchema = [3, n0, _ECUP,
  0,
  [_eInvi, _eRAn, _eCNn, _eP],
  [0, () => EnvironmentResolvedAccount$, [() => EnvironmentConfigurationName, 0], () => EnvironmentParametersList]
];
export var EnvironmentDeploymentDetails$: StaticStructureSchema = [3, n0, _EDD,
  0,
  [_oDS, _eFR],
...
export var GetLineageEventOutput$: StaticStructureSchema = [3, n0, _GLEO,
  ...
  [[0, { [_hH]: _DI }], [0, { [_hH]: _I }], [() => LineageEvent, 16], [0, { [_hH]: _CB }], [0, { [_hH]: _PS }], [4, { [_hH]: _ET }], [4, { [_hH]: _CA }]]
];
...
export var GlossaryTermEnforcementDetail$: StaticStructureSchema = [3, n0, _GTED,
  0,
  [_rGTI],
  [64 | 0]
];
...
export var GlueOAuth2Credentials$: StaticStructureSchema = [3, n0, _GOAC,
  8,
  [_uMCACS, _aTc, _rTe, _jTw],
  [0, 0, 0, 0]
];
export var GluePropertiesInput$: StaticStructureSchema = [3, n0, _GPIl,
  0,
  [_gCI],
  [[() => GlueConnectionInput$, 0]]
];
export var GluePropertiesOutput$: StaticStructureSchema = [3, n0, _GPOl,
  0,
  [_st, _eM],
  [0, 0]
];
...
export var IamPropertiesPatch$: StaticStructureSchema = [3, n0, _IPP,
  0,
  [_gLSE],
  [2]
];
...
export var LineageInfo$: StaticStructureSchema = [3, n0, _LI,
  0,
  [_eIv, _eSve, _eM],
  [0, 0, 0]
];
...
export var LineageSqlQueryRunDetails$: StaticStructureSchema = [3, n0, _LSQRD,
  0,
...
export var ManagedEndpointCredentials$: StaticStructureSchema = [3, n0, _MEC,
  8,
  [_id, _to],
  [0, 0]
];
export var MatchOffset$: StaticStructureSchema = [3, n0, _MO,
  0,
  [_sOt, _eO],
  [1, 1]
];
export var MetadataFormEnforcementDetail$: StaticStructureSchema = [3, n0, _MFED,
  0,
  [_rMF],
...
export var MlflowPropertiesOutput$: StaticStructureSchema = [3, n0, _MPO,
  0,
  [_tSA],
  [0]
];
export var MlflowPropertiesPatch$: StaticStructureSchema = [3, n0, _MPP,
  0,
  [_tSA],
  [0]
];
export var NameIdentifier$: StaticStructureSchema = [3, n0, _NI,
  0,
  [_n, _na],
  [0, 0]
];
...
export var OpenLineageRunEventSummary$: StaticStructureSchema = [3, n0, _OLRES,
  0,
  [_eTven, _rIu, _j, _in, _ou],
  [0, 0, () => NameIdentifier$, () => NameIdentifiers, () => NameIdentifiers]
];
export var OverrideDomainUnitOwnersPolicyGrantDetail$: StaticStructureSchema = [3, n0, _ODUOPGD,
  0,
  [_iCDU],
  [2]
];
export var OverrideProjectOwnersPolicyGrantDetail$: StaticStructureSchema = [3, n0, _OPOPGD,
  0,
  [_iCDU],
  [2]
];
...
export var PredictionConfiguration$: StaticStructureSchema = [3, n0, _PC,
  0,
  [_bNG],
  [() => BusinessNameGenerationConfiguration$]
];
export var ProjectDeletionError$: StaticStructureSchema = [3, n0, _PDE,
  0,
  [_cod, _m],
  [0, 0]
];
...
export var RedshiftLineageSyncConfigurationOutput$: StaticStructureSchema = [3, n0, _RLSCO,
  0,
  [_lJI, _en, _sch],
  [0, 2, () => LineageSyncSchedule$]
];
export var RedshiftPropertiesInput$: StaticStructureSchema = [3, n0, _RPI,
  0,
  [_sto, _dNa, _h, _po, _cr, _lSin],
  [() => RedshiftStorageProperties$, 0, 0, 1, [() => RedshiftCredentials$, 0], () => RedshiftLineageSyncConfigurationInput$]
];
export var RedshiftPropertiesOutput$: StaticStructureSchema = [3, n0, _RPO,
  0,
...
export var RedshiftPropertiesPatch$: StaticStructureSchema = [3, n0, _RPP,
  0,
  [_sto, _dNa, _h, _po, _cr, _lSin],
  [() => RedshiftStorageProperties$, 0, 0, 1, [() => RedshiftCredentials$, 0], () => RedshiftLineageSyncConfigurationInput$]
];
...
export var RunStatisticsForAssets$: StaticStructureSchema = [3, n0, _RSFA,
  0,
  [_ad, _up, _un, _sk, _fa],
  [1, 1, 1, 1, 1]
];
...
export var SubscribedGroup$: StaticStructureSchema = [3, n0, _SG,
  0,
  [_id, _n],
  [0, [() => GroupProfileName, 0]]
];
export var SubscribedGroupInput$: StaticStructureSchema = [3, n0, _SGI,
  0,
  [_i],
  [0]
];
...
export var SubscribedProject$: StaticStructureSchema = [3, n0, _SP,
  0,
  [_id, _n],
  [0, [() => ProjectName, 0]]
];
export var SubscribedProjectInput$: StaticStructureSchema = [3, n0, _SPIu,
  0,
  [_i],
  [0]
];
export var SubscribedUser$: StaticStructureSchema = [3, n0, _SU,
  0,
  [_id, _det],
  [0, [() => UserProfileDetails$, 0]]
];
export var SubscribedUserInput$: StaticStructureSchema = [3, n0, _SUI,
  0,
  [_i],
  [0]
];
...
export var UseAssetTypePolicyGrantDetail$: StaticStructureSchema = [3, n0, _UATPGD,
  0,
  [_dUI],
  [0]
];
...
export var WorkflowsMwaaPropertiesOutput$: StaticStructureSchema = [3, n0, _WMPO,
  0,
  [_mEN],
  [0]
];
export var WorkflowsServerlessPropertiesInput$: StaticStructureSchema = [3, n0, _WSPI,
  0,
  [],
  []
];
export var WorkflowsServerlessPropertiesOutput$: StaticStructureSchema = [3, n0, _WSPO,
  0,
  [],
  []
];
var __Unit = "unit" as const;
var AcceptChoices: StaticListSchema = [1, n0, _ACc,
  0, [() => AcceptChoice$,
    0]
];
var AcceptedAssetScopes: StaticListSchema = [1, n0, _AASc,
  0, () => AcceptedAssetScope$
];
...
var AccountPoolSummaries: StaticListSchema = [1, n0, _APSc,
  0, [() => AccountPoolSummary$,
    0]
];
var AggregationList: StaticListSchema = [1, n0, _ALg,
  0, () => AggregationListItem$
];
var AggregationOutputItems: StaticListSchema = [1, n0, _AOIg,
  0, () => AggregationOutputItem$
];
var AggregationOutputList: StaticListSchema = [1, n0, _AOL,
  0, () => AggregationOutput$
];
var ApplicableAssetTypes = 64 | 0;
var AssetFilters: StaticListSchema = [1, n0, _AF,
  0, [() => AssetFilterSummary$,
    0]
];
var AssetInDataProductListingItems: StaticListSchema = [1, n0, _AIDPLIs,
  0, () => AssetInDataProductListingItem$
];
var AssetPermissions: StaticListSchema = [1, n0, _APs,
  0, () => AssetPermission$
];
var AssetRevisions: StaticListSchema = [1, n0, _ARss,
  0, () => AssetRevision$
];
var AssetTargetNames: StaticListSchema = [1, n0, _ATN,
  0, () => AssetTargetNameMap$
];
var AssetTypeIdentifiers = 64 | 0;
var Attributes: StaticListSchema = [1, n0, _A,
  0, [() => AttributeInput$,
    0]
];
var AttributesErrors: StaticListSchema = [1, n0, _AEt,
  0, () => AttributeError$
];
var AttributesList = 64 | 0;
var AuthorizedPrincipalIdentifiers = 64 | 0;
var AwsRegionList = 64 | 0;
var BatchGetAttributeItems: StaticListSchema = [1, n0, _BGAI,
  0, [() => BatchGetAttributeOutput$,
    0]
];
var BatchPutAttributeItems: StaticListSchema = [1, n0, _BPAI,
...
var CustomParameterList: StaticListSchema = [1, n0, _CPL,
  0, [() => CustomParameter$,
    0]
];
var DataProductItems: StaticListSchema = [1, n0, _DPIa,
  0, () => DataProductItem$
];
var DataProductRevisions: StaticListSchema = [1, n0, _DPRa,
  0, () => DataProductRevision$
];
var DataSourceRunActivities: StaticListSchema = [1, n0, _DSRAa,
  0, [() => DataSourceRunActivity$,
    0]
];
var DataSourceRunSummaries: StaticListSchema = [1, n0, _DSRSa,
  0, () => DataSourceRunSummary$
];
...
var DetailedGlossaryTerms: StaticListSchema = [1, n0, _DGTe,
  0, [() => DetailedGlossaryTerm$,
    0]
];
var DomainSummaries: StaticListSchema = [1, n0, _DSo,
  0, [() => DomainSummary$,
    0]
];
var DomainUnitIds = 64 | 0;
var DomainUnitOwners: StaticListSchema = [1, n0, _DUO,
  0, () => DomainUnitOwnerProperties$
];
var DomainUnitSummaries: StaticListSchema = [1, n0, _DUSo,
  0, () => DomainUnitSummary$
];
var EnabledRegionList = 64 | 0;
var EntityOwners: StaticListSchema = [1, n0, _EO,
  0, () => OwnerPropertiesOutput$
];
var EnvironmentActionList: StaticListSchema = [1, n0, _EAL,
  0, () => ConfigurableEnvironmentAction$
];
var EnvironmentBlueprintConfigurations: StaticListSchema = [1, n0, _EBC,
  0, () => EnvironmentBlueprintConfigurationItem$
];
var EnvironmentBlueprintSummaries: StaticListSchema = [1, n0, _EBSn,
  0, [() => EnvironmentBlueprintSummary$,
    0]
];
var EnvironmentConfigurationParametersList: StaticListSchema = [1, n0, _ECPL,
  0, () => EnvironmentConfigurationParameter$
];
var EnvironmentConfigurationsList: StaticListSchema = [1, n0, _ECL,
  0, [() => EnvironmentConfiguration$,
    0]
];
var EnvironmentConfigurationUserParametersList: StaticListSchema = [1, n0, _ECUPL,
  0, [() => EnvironmentConfigurationUserParameter$,
    0]
];
var EnvironmentFailureReasonsList: StaticListSchema = [1, n0, _EFRL,
  0, () => EnvironmentError$
];
var EnvironmentParametersList: StaticListSchema = [1, n0, _EPL,
  0, () => EnvironmentParameter$
];
var EnvironmentProfileSummaries: StaticListSchema = [1, n0, _EPSn,
  0, [() => EnvironmentProfileSummary$,
    0]
];
var EnvironmentSummaries: StaticListSchema = [1, n0, _ESn,
...
var FormInputList: StaticListSchema = [1, n0, _FIL,
  8, [() => FormInput$,
    0]
];
...
var JobRunSummaries: StaticListSchema = [1, n0, _JRSo,
  0, () => JobRunSummary$
];
...
var LineageNodeSummaries: StaticListSchema = [1, n0, _LNSi,
  0, () => LineageNodeSummary$
];
var ListEnvironmentActionSummaries: StaticListSchema = [1, n0, _LEAS,
  0, () => EnvironmentActionSummary$
];
var ListingSummaries: StaticListSchema = [1, n0, _LSi,
  0, [() => ListingSummary$,
    0]
];
...
var MatchRationale: StaticListSchema = [1, n0, _MR,
  0, () => MatchRationaleItem$
];
var MetadataFormInputs: StaticListSchema = [1, n0, _MFI,
  0, [() => FormInput$,
    0]
];
var MetadataForms: StaticListSchema = [1, n0, _MF,
  0, [() => FormOutput$,
    0]
];
var MetadataFormsSummary: StaticListSchema = [1, n0, _MFSe,
  0, [() => MetadataFormSummary$,
    0]
];
var MetadataGenerationRuns: StaticListSchema = [1, n0, _MGR,
  0, () => MetadataGenerationRunItem$
];
var MetadataGenerationRunTypes = 64 | 0;
var MetadataGenerationRunTypeStats: StaticListSchema = [1, n0, _MGRTSe,
  0, () => MetadataGenerationRunTypeStat$
];
var NameIdentifiers: StaticListSchema = [1, n0, _NIa,
  0, () => NameIdentifier$
];
...
var PolicyGrantList: StaticListSchema = [1, n0, _PGL,
  0, () => PolicyGrantMember$
];
...
var ProjectResourceTagParameters: StaticListSchema = [1, n0, _PRTP,
  0, () => ResourceTagParameter$
];
...
var RelationalFilterConfigurations: StaticListSchema = [1, n0, _RFCe,
  0, () => RelationalFilterConfiguration$
];
...
var SearchInventoryResultItems: StaticListSchema = [1, n0, _SIRI,
  0, [() => SearchInventoryResultItem$,
    0]
];
var SearchOutputAdditionalAttributes = 64 | 0;
var SearchResultItems: StaticListSchema = [1, n0, _SRI,
  0, [() => SearchResultItem$,
    0]
];
var SearchTypesResultItems: StaticListSchema = [1, n0, _STRI,
  0, [() => SearchTypesResultItem$,
    0]
];
var SecurityGroupIdList = 64 | 0;
var SelfGrantStatusDetails: StaticListSchema = [1, n0, _SGSDe,
  0, () => SelfGrantStatusDetail$
];
var StringList = 64 | 0;
var SubnetIdList = 64 | 0;
var SubscribedAssets: StaticListSchema = [1, n0, _SAu,
  0, () => SubscribedAsset$
];
var SubscribedListingInputs: StaticListSchema = [1, n0, _SLIub,
  0, () => SubscribedListingInput$
];
var SubscribedListings: StaticListSchema = [1, n0, _SLu,
  0, [() => SubscribedListing$,
    0]
];
var SubscribedPrincipalInputs: StaticListSchema = [1, n0, _SPIub,
  0, () => SubscribedPrincipalInput$
];
var SubscribedPrincipals: StaticListSchema = [1, n0, _SPu,
  0, [() => SubscribedPrincipal$,
    0]
];
var SubscriptionGrants: StaticListSchema = [1, n0, _SGu,
  0, () => SubscriptionGrantSummary$
];
var SubscriptionRequests: StaticListSchema = [1, n0, _SR,
  0, [() => SubscriptionRequestSummary$,
    0]
];
var Subscriptions: StaticListSchema = [1, n0, _S,
  0, [() => SubscriptionSummary$,
    0]
];
var SubscriptionTargetForms: StaticListSchema = [1, n0, _STFu,
  0, () => SubscriptionTargetForm$
];
var SubscriptionTargets: StaticListSchema = [1, n0, _ST,
  0, [() => SubscriptionTargetSummary$,
    0]
];
var TagKeyList = 64 | 0;
var TextMatches: StaticListSchema = [1, n0, _TM,
  0, () => TextMatchItem$
];
var TimeSeriesDataPointFormInputList: StaticListSchema = [1, n0, _TSDPFIL,
  0, () => TimeSeriesDataPointFormInput$
];
var TimeSeriesDataPointFormOutputList: StaticListSchema = [1, n0, _TSDPFOL,
  0, () => TimeSeriesDataPointFormOutput$
];
var TimeSeriesDataPointSummaryFormOutputList: StaticListSchema = [1, n0, _TSDPSFOL,
  0, () => TimeSeriesDataPointSummaryFormOutput$
];
var TrackingAssetArns = 64 | 0;
var UserProfileSummaries: StaticListSchema = [1, n0, _UPSs,
...
var EnvironmentFailureReasons: StaticMapSchema = [2, n0, _EFR,
  0, 0, () => EnvironmentFailureReasonsList
];
var FormsInputMap: StaticMapSchema = [2, n0, _FIM,
  0, 0, () => FormEntryInput$
];
var FormsOutputMap: StaticMapSchema = [2, n0, _FOM,
  0, [0,
    0]
  , [() => FormEntryOutput$,
    0]
...
export var AccountSource$: StaticUnionSchema = [4, n0, _ASc,
  0,
  [_acc, _cAPH],
  [[() => AccountInfoList, 0], () => CustomAccountPoolHandler$]
];
export var ActionParameters$: StaticUnionSchema = [4, n0, _APc,
  0,
  [_aCL],
  [() => AwsConsoleLinkParameters$]
];
export var AssetFilterConfiguration$: StaticUnionSchema = [4, n0, _AFC,
  0,
  [_cCo, _rCo],
...
export var DataSourceConfigurationOutput$: StaticUnionSchema = [4, n0, _DSCO,
  0,
  [_gRC, _rRC, _sMRC],
  [() => GlueRunConfigurationOutput$, () => RedshiftRunConfigurationOutput$, () => SageMakerRunConfigurationOutput$]
];
export var DomainUnitGrantFilter$: StaticUnionSchema = [4, n0, _DUGF,
  0,
  [_aDUGF],
  [() => AllDomainUnitsGrantFilter$]
];
export var DomainUnitOwnerProperties$: StaticUnionSchema = [4, n0, _DUOP,
  0,
  [_use, _g],
  [() => DomainUnitUserProperties$, () => DomainUnitGroupProperties$]
];
export var EventSummary$: StaticUnionSchema = [4, n0, _ESv,
  0,
  [_oLRES],
  [() => OpenLineageRunEventSummary$]
];
export var FilterClause$: StaticUnionSchema = [4, n0, _FCi,
  0,
  [_fil, _an, _or_],
  [() => Filter$, () => FilterList, () => FilterList]
];
export var GrantedEntity$: StaticUnionSchema = [4, n0, _GE,
  0,
  [_l],
  [() => ListingRevision$]
];
export var GrantedEntityInput$: StaticUnionSchema = [4, n0, _GEIr,
  0,
  [_l],
  [() => ListingRevisionInput$]
];
export var GroupPolicyGrantPrincipal$: StaticUnionSchema = [4, n0, _GPGP,
  0,
  [_gIr],
  [0]
];
export var JobRunDetails$: StaticUnionSchema = [4, n0, _JRD,
  0,
  [_lRD],
  [() => LineageRunDetails$]
];
export var ListingItem$: StaticUnionSchema = [4, n0, _LIi,
  0,
  [_aLss, _dPL],
...
export var Member$: StaticUnionSchema = [4, n0, _Me,
  0,
  [_uI, _gIr],
  [0, 0]
];
export var MemberDetails$: StaticUnionSchema = [4, n0, _MD,
  0,
  [_use, _g],
  [() => UserDetails$, () => GroupDetails$]
];
export var Model$: StaticUnionSchema = [4, n0, _Mo,
  8,
  [_sm],
  [0]
];
...
export var OwnerPropertiesOutput$: StaticUnionSchema = [4, n0, _OPO,
  0,
  [_use, _g],
  [() => OwnerUserPropertiesOutput$, () => OwnerGroupPropertiesOutput$]
];
export var Permissions$: StaticUnionSchema = [4, n0, _Pe,
  0,
  [_s_],
  [64 | 0]
];
export var PolicyGrantDetail$: StaticUnionSchema = [4, n0, _PGD,
  0,
...
export var PolicyGrantPrincipal$: StaticUnionSchema = [4, n0, _PGP,
  0,
  [_use, _g, _proj, _dU],
  [() => UserPolicyGrantPrincipal$, () => GroupPolicyGrantPrincipal$, () => ProjectPolicyGrantPrincipal$, () => DomainUnitPolicyGrantPrincipal$]
];
export var ProjectGrantFilter$: StaticUnionSchema = [4, n0, _PGF,
  0,
  [_dUF],
  [() => DomainUnitFilterForProject$]
];
export var ProvisioningConfiguration$: StaticUnionSchema = [4, n0, _PCr,
  0,
  [_lFC],
  [() => LakeFormationConfiguration$]
];
export var ProvisioningProperties$: StaticUnionSchema = [4, n0, _PP,
  0,
  [_cF],
  [() => CloudFormationProperties$]
];
export var RedshiftCredentials$: StaticUnionSchema = [4, n0, _RCed,
  8,
  [_sA, _uPs],
  [0, [() => UsernamePassword$, 0]]
];
export var RedshiftStorage$: StaticUnionSchema = [4, n0, _RSe,
  0,
  [_rCS, _rSS],
  [() => RedshiftClusterStorage$, () => RedshiftServerlessStorage$]
];
export var RedshiftStorageProperties$: StaticUnionSchema = [4, n0, _RSP,
  0,
  [_cNl, _wN],
  [0, 0]
];
export var Region$: StaticUnionSchema = [4, n0, _Re,
  0,
  [_rN, _rNP],
  [0, 0]
];
...
export var RowFilterExpression$: StaticUnionSchema = [4, n0, _RFE,
  0,
...
export var RuleDetail$: StaticUnionSchema = [4, n0, _RD,
  0,
  [_mFED, _gTED],
  [() => MetadataFormEnforcementDetail$, () => GlossaryTermEnforcementDetail$]
];
export var RuleTarget$: StaticUnionSchema = [4, n0, _RTu,
  0,
  [_dUT],
  [() => DomainUnitTarget$]
];
export var SearchInventoryResultItem$: StaticUnionSchema = [4, n0, _SIRIe,
  0,
  [_gIlos, _gTI, _aIss, _dPIa],
  [[() => GlossaryItem$, 0], [() => GlossaryTermItem$, 0], [() => AssetItem$, 0], [() => DataProductResultItem$, 0]]
];
export var SearchResultItem$: StaticUnionSchema = [4, n0, _SRIe,
  0,
  [_aLss, _dPL],
  [[() => AssetListingItem$, 0], [() => DataProductListingItem$, 0]]
];
export var SearchTypesResultItem$: StaticUnionSchema = [4, n0, _STRIe,
  0,
  [_aTI, _fTIo, _lNTI],
  [[() => AssetTypeItem$, 0], [() => FormTypeData$, 0], [() => LineageNodeTypeItem$, 0]]
];
export var SelfGrantStatusOutput$: StaticUnionSchema = [4, n0, _SGSO,
  0,
  [_gSGS, _rSGS],
...
export var SubscribedListingItem$: StaticUnionSchema = [4, n0, _SLIubs,
  0,
  [_aLss, _pL],
  [[() => SubscribedAssetListing$, 0], [() => SubscribedProductListing$, 0]]
];
...
export var UserProfileDetails$: StaticUnionSchema = [4, n0, _UPD,
  0,
  [_ia, _ss],
  [() => IamUserProfileDetails$, [() => SsoUserProfileDetails$, 0]]
];
export var AcceptPredictions$: StaticOperationSchema = [9, n0, _APcc,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/assets/{identifier}/accept-predictions", 200] }, () => AcceptPredictionsInput$, () => AcceptPredictionsOutput$
];
export var AcceptSubscriptionRequest$: StaticOperationSchema = [9, n0, _ASR,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/subscription-requests/{identifier}/accept", 200] }, () => AcceptSubscriptionRequestInput$, () => AcceptSubscriptionRequestOutput$
];
export var AddEntityOwner$: StaticOperationSchema = [9, n0, _AEO,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/addOwner", 201] }, () => AddEntityOwnerInput$, () => AddEntityOwnerOutput$
];
export var AddPolicyGrant$: StaticOperationSchema = [9, n0, _APG,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/policies/managed/{entityType}/{entityIdentifier}/addGrant", 201] }, () => AddPolicyGrantInput$, () => AddPolicyGrantOutput$
];
export var AssociateEnvironmentRole$: StaticOperationSchema = [9, n0, _AER,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/roles/{environmentRoleArn}", 200] }, () => AssociateEnvironmentRoleInput$, () => AssociateEnvironmentRoleOutput$
];
export var AssociateGovernedTerms$: StaticOperationSchema = [9, n0, _AGT,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/associate-governed-terms", 200] }, () => AssociateGovernedTermsInput$, () => AssociateGovernedTermsOutput$
];
export var BatchGetAttributesMetadata$: StaticOperationSchema = [9, n0, _BGAM,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/attributes-metadata", 200] }, () => BatchGetAttributesMetadataInput$, () => BatchGetAttributesMetadataOutput$
];
export var BatchPutAttributesMetadata$: StaticOperationSchema = [9, n0, _BPAM,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/attributes-metadata", 200] }, () => BatchPutAttributesMetadataInput$, () => BatchPutAttributesMetadataOutput$
];
export var CancelMetadataGenerationRun$: StaticOperationSchema = [9, n0, _CMGR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/metadata-generation-runs/{identifier}/cancel", 200] }, () => CancelMetadataGenerationRunInput$, () => CancelMetadataGenerationRunOutput$
];
export var CancelSubscription$: StaticOperationSchema = [9, n0, _CSa,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/subscriptions/{identifier}/cancel", 200] }, () => CancelSubscriptionInput$, () => CancelSubscriptionOutput$
];
export var CreateAccountPool$: StaticOperationSchema = [9, n0, _CAPr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/account-pools", 201] }, () => CreateAccountPoolInput$, () => CreateAccountPoolOutput$
];
export var CreateAsset$: StaticOperationSchema = [9, n0, _CAr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/assets", 201] }, () => CreateAssetInput$, () => CreateAssetOutput$
];
export var CreateAssetFilter$: StaticOperationSchema = [9, n0, _CAF,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/assets/{assetIdentifier}/filters", 201] }, () => CreateAssetFilterInput$, () => CreateAssetFilterOutput$
];
export var CreateAssetRevision$: StaticOperationSchema = [9, n0, _CAR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/assets/{identifier}/revisions", 200] }, () => CreateAssetRevisionInput$, () => CreateAssetRevisionOutput$
];
export var CreateAssetType$: StaticOperationSchema = [9, n0, _CAT,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/asset-types", 201] }, () => CreateAssetTypeInput$, () => CreateAssetTypeOutput$
];
export var CreateConnection$: StaticOperationSchema = [9, n0, _CCr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/connections", 201] }, () => CreateConnectionInput$, () => CreateConnectionOutput$
];
export var CreateDataProduct$: StaticOperationSchema = [9, n0, _CDP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/data-products", 201] }, () => CreateDataProductInput$, () => CreateDataProductOutput$
];
export var CreateDataProductRevision$: StaticOperationSchema = [9, n0, _CDPR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/data-products/{identifier}/revisions", 201] }, () => CreateDataProductRevisionInput$, () => CreateDataProductRevisionOutput$
];
export var CreateDataSource$: StaticOperationSchema = [9, n0, _CDS,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/data-sources", 201] }, () => CreateDataSourceInput$, () => CreateDataSourceOutput$
];
export var CreateDomain$: StaticOperationSchema = [9, n0, _CD,
  { [_ht]: ["POST", "/v2/domains", 201] }, () => CreateDomainInput$, () => CreateDomainOutput$
];
export var CreateDomainUnit$: StaticOperationSchema = [9, n0, _CDU,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/domain-units", 201] }, () => CreateDomainUnitInput$, () => CreateDomainUnitOutput$
];
export var CreateEnvironment$: StaticOperationSchema = [9, n0, _CEr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/environments", 201] }, () => CreateEnvironmentInput$, () => CreateEnvironmentOutput$
];
export var CreateEnvironmentAction$: StaticOperationSchema = [9, n0, _CEAr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/actions", 201] }, () => CreateEnvironmentActionInput$, () => CreateEnvironmentActionOutput$
];
export var CreateEnvironmentBlueprint$: StaticOperationSchema = [9, n0, _CEB,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/environment-blueprints", 201] }, () => CreateEnvironmentBlueprintInput$, () => CreateEnvironmentBlueprintOutput$
];
export var CreateEnvironmentProfile$: StaticOperationSchema = [9, n0, _CEP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/environment-profiles", 201] }, () => CreateEnvironmentProfileInput$, () => CreateEnvironmentProfileOutput$
];
export var CreateFormType$: StaticOperationSchema = [9, n0, _CFT,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/form-types", 201] }, () => CreateFormTypeInput$, () => CreateFormTypeOutput$
];
export var CreateGlossary$: StaticOperationSchema = [9, n0, _CG,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/glossaries", 201] }, () => CreateGlossaryInput$, () => CreateGlossaryOutput$
];
export var CreateGlossaryTerm$: StaticOperationSchema = [9, n0, _CGT,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/glossary-terms", 201] }, () => CreateGlossaryTermInput$, () => CreateGlossaryTermOutput$
];
export var CreateGroupProfile$: StaticOperationSchema = [9, n0, _CGP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/group-profiles", 201] }, () => CreateGroupProfileInput$, () => CreateGroupProfileOutput$
];
...
export var CreateProjectMembership$: StaticOperationSchema = [9, n0, _CPM,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/projects/{projectIdentifier}/createMembership", 201] }, () => CreateProjectMembershipInput$, () => CreateProjectMembershipOutput$
];
export var CreateProjectProfile$: StaticOperationSchema = [9, n0, _CPPr,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/project-profiles", 201] }, () => CreateProjectProfileInput$, () => CreateProjectProfileOutput$
];
export var CreateRule$: StaticOperationSchema = [9, n0, _CR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/rules", 201] }, () => CreateRuleInput$, () => CreateRuleOutput$
];
export var CreateSubscriptionGrant$: StaticOperationSchema = [9, n0, _CSG,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/subscription-grants", 200] }, () => CreateSubscriptionGrantInput$, () => CreateSubscriptionGrantOutput$
];
export var CreateSubscriptionRequest$: StaticOperationSchema = [9, n0, _CSR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/subscription-requests", 200] }, () => CreateSubscriptionRequestInput$, () => CreateSubscriptionRequestOutput$
];
export var CreateSubscriptionTarget$: StaticOperationSchema = [9, n0, _CST,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/subscription-targets", 200] }, () => CreateSubscriptionTargetInput$, () => CreateSubscriptionTargetOutput$
];
export var CreateUserProfile$: StaticOperationSchema = [9, n0, _CUP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/user-profiles", 201] }, () => CreateUserProfileInput$, () => CreateUserProfileOutput$
];
export var DeleteAccountPool$: StaticOperationSchema = [9, n0, _DAP,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/account-pools/{identifier}", 204] }, () => DeleteAccountPoolInput$, () => DeleteAccountPoolOutput$
];
export var DeleteAsset$: StaticOperationSchema = [9, n0, _DA,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/assets/{identifier}", 204] }, () => DeleteAssetInput$, () => DeleteAssetOutput$
];
export var DeleteAssetFilter$: StaticOperationSchema = [9, n0, _DAF,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/assets/{assetIdentifier}/filters/{identifier}", 204] }, () => DeleteAssetFilterInput$, () => __Unit
];
export var DeleteAssetType$: StaticOperationSchema = [9, n0, _DAT,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/asset-types/{identifier}", 204] }, () => DeleteAssetTypeInput$, () => DeleteAssetTypeOutput$
];
...
export var DeleteDataSource$: StaticOperationSchema = [9, n0, _DDS,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/data-sources/{identifier}", 200] }, () => DeleteDataSourceInput$, () => DeleteDataSourceOutput$
];
export var DeleteDomain$: StaticOperationSchema = [9, n0, _DDe,
  { [_ht]: ["DELETE", "/v2/domains/{identifier}", 202] }, () => DeleteDomainInput$, () => DeleteDomainOutput$
];
export var DeleteDomainUnit$: StaticOperationSchema = [9, n0, _DDU,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/domain-units/{identifier}", 204] }, () => DeleteDomainUnitInput$, () => DeleteDomainUnitOutput$
];
export var DeleteEnvironment$: StaticOperationSchema = [9, n0, _DE,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environments/{identifier}", 204] }, () => DeleteEnvironmentInput$, () => __Unit
];
export var DeleteEnvironmentAction$: StaticOperationSchema = [9, n0, _DEA,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/actions/{identifier}", 204] }, () => DeleteEnvironmentActionInput$, () => __Unit
];
export var DeleteEnvironmentBlueprint$: StaticOperationSchema = [9, n0, _DEB,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environment-blueprints/{identifier}", 204] }, () => DeleteEnvironmentBlueprintInput$, () => __Unit
];
export var DeleteEnvironmentBlueprintConfiguration$: StaticOperationSchema = [9, n0, _DEBC,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environment-blueprint-configurations/{environmentBlueprintIdentifier}", 204] }, () => DeleteEnvironmentBlueprintConfigurationInput$, () => DeleteEnvironmentBlueprintConfigurationOutput$
];
export var DeleteEnvironmentProfile$: StaticOperationSchema = [9, n0, _DEP,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environment-profiles/{identifier}", 204] }, () => DeleteEnvironmentProfileInput$, () => __Unit
];
export var DeleteFormType$: StaticOperationSchema = [9, n0, _DFT,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/form-types/{formTypeIdentifier}", 204] }, () => DeleteFormTypeInput$, () => DeleteFormTypeOutput$
];
export var DeleteGlossary$: StaticOperationSchema = [9, n0, _DG,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/glossaries/{identifier}", 204] }, () => DeleteGlossaryInput$, () => DeleteGlossaryOutput$
];
...
export var DeleteProjectMembership$: StaticOperationSchema = [9, n0, _DPM,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/projects/{projectIdentifier}/deleteMembership", 204] }, () => DeleteProjectMembershipInput$, () => DeleteProjectMembershipOutput$
];
export var DeleteProjectProfile$: StaticOperationSchema = [9, n0, _DPP,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/project-profiles/{identifier}", 204] }, () => DeleteProjectProfileInput$, () => DeleteProjectProfileOutput$
];
export var DeleteRule$: StaticOperationSchema = [9, n0, _DR,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/rules/{identifier}", 204] }, () => DeleteRuleInput$, () => DeleteRuleOutput$
];
export var DeleteSubscriptionGrant$: StaticOperationSchema = [9, n0, _DSG,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/subscription-grants/{identifier}", 200] }, () => DeleteSubscriptionGrantInput$, () => DeleteSubscriptionGrantOutput$
];
export var DeleteSubscriptionRequest$: StaticOperationSchema = [9, n0, _DSR,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/subscription-requests/{identifier}", 204] }, () => DeleteSubscriptionRequestInput$, () => __Unit
];
export var DeleteSubscriptionTarget$: StaticOperationSchema = [9, n0, _DST,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/subscription-targets/{identifier}", 204] }, () => DeleteSubscriptionTargetInput$, () => __Unit
];
export var DeleteTimeSeriesDataPoints$: StaticOperationSchema = [9, n0, _DTSDP,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/time-series-data-points", 204] }, () => DeleteTimeSeriesDataPointsInput$, () => DeleteTimeSeriesDataPointsOutput$
];
export var DisassociateEnvironmentRole$: StaticOperationSchema = [9, n0, _DER,
  { [_ht]: ["DELETE", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/roles/{environmentRoleArn}", 200] }, () => DisassociateEnvironmentRoleInput$, () => DisassociateEnvironmentRoleOutput$
];
export var DisassociateGovernedTerms$: StaticOperationSchema = [9, n0, _DGTi,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/disassociate-governed-terms", 200] }, () => DisassociateGovernedTermsInput$, () => DisassociateGovernedTermsOutput$
];
export var GetAccountPool$: StaticOperationSchema = [9, n0, _GAP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/account-pools/{identifier}", 200] }, () => GetAccountPoolInput$, () => GetAccountPoolOutput$
];
export var GetAsset$: StaticOperationSchema = [9, n0, _GA,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/assets/{identifier}", 200] }, () => GetAssetInput$, () => GetAssetOutput$
];
export var GetAssetFilter$: StaticOperationSchema = [9, n0, _GAF,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/assets/{assetIdentifier}/filters/{identifier}", 200] }, () => GetAssetFilterInput$, () => GetAssetFilterOutput$
];
export var GetAssetType$: StaticOperationSchema = [9, n0, _GAT,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/asset-types/{identifier}", 200] }, () => GetAssetTypeInput$, () => GetAssetTypeOutput$
];
export var GetConnection$: StaticOperationSchema = [9, n0, _GCe,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/connections/{identifier}", 200] }, () => GetConnectionInput$, () => GetConnectionOutput$
];
export var GetDataExportConfiguration$: StaticOperationSchema = [9, n0, _GDEC,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-export-configuration", 200] }, () => GetDataExportConfigurationInput$, () => GetDataExportConfigurationOutput$
];
export var GetDataProduct$: StaticOperationSchema = [9, n0, _GDP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-products/{identifier}", 200] }, () => GetDataProductInput$, () => GetDataProductOutput$
];
export var GetDataSource$: StaticOperationSchema = [9, n0, _GDS,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-sources/{identifier}", 200] }, () => GetDataSourceInput$, () => GetDataSourceOutput$
];
export var GetDataSourceRun$: StaticOperationSchema = [9, n0, _GDSR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-source-runs/{identifier}", 200] }, () => GetDataSourceRunInput$, () => GetDataSourceRunOutput$
];
export var GetDomain$: StaticOperationSchema = [9, n0, _GDe,
  { [_ht]: ["GET", "/v2/domains/{identifier}", 200] }, () => GetDomainInput$, () => GetDomainOutput$
];
export var GetDomainUnit$: StaticOperationSchema = [9, n0, _GDU,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/domain-units/{identifier}", 200] }, () => GetDomainUnitInput$, () => GetDomainUnitOutput$
];
export var GetEnvironment$: StaticOperationSchema = [9, n0, _GEe,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{identifier}", 200] }, () => GetEnvironmentInput$, () => GetEnvironmentOutput$
];
export var GetEnvironmentAction$: StaticOperationSchema = [9, n0, _GEA,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/actions/{identifier}", 200] }, () => GetEnvironmentActionInput$, () => GetEnvironmentActionOutput$
];
export var GetEnvironmentBlueprint$: StaticOperationSchema = [9, n0, _GEB,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-blueprints/{identifier}", 200] }, () => GetEnvironmentBlueprintInput$, () => GetEnvironmentBlueprintOutput$
];
export var GetEnvironmentBlueprintConfiguration$: StaticOperationSchema = [9, n0, _GEBC,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-blueprint-configurations/{environmentBlueprintIdentifier}", 200] }, () => GetEnvironmentBlueprintConfigurationInput$, () => GetEnvironmentBlueprintConfigurationOutput$
];
export var GetEnvironmentCredentials$: StaticOperationSchema = [9, n0, _GEC,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/credentials", 200] }, () => GetEnvironmentCredentialsInput$, () => GetEnvironmentCredentialsOutput$
];
export var GetEnvironmentProfile$: StaticOperationSchema = [9, n0, _GEP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-profiles/{identifier}", 200] }, () => GetEnvironmentProfileInput$, () => GetEnvironmentProfileOutput$
];
export var GetFormType$: StaticOperationSchema = [9, n0, _GFT,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/form-types/{formTypeIdentifier}", 200] }, () => GetFormTypeInput$, () => GetFormTypeOutput$
];
export var GetGlossary$: StaticOperationSchema = [9, n0, _GG,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/glossaries/{identifier}", 200] }, () => GetGlossaryInput$, () => GetGlossaryOutput$
];
export var GetGlossaryTerm$: StaticOperationSchema = [9, n0, _GGT,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/glossary-terms/{identifier}", 200] }, () => GetGlossaryTermInput$, () => GetGlossaryTermOutput$
];
export var GetGroupProfile$: StaticOperationSchema = [9, n0, _GGP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/group-profiles/{groupIdentifier}", 200] }, () => GetGroupProfileInput$, () => GetGroupProfileOutput$
];
export var GetIamPortalLoginUrl$: StaticOperationSchema = [9, n0, _GIPLU,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/get-portal-login-url", 200] }, () => GetIamPortalLoginUrlInput$, () => GetIamPortalLoginUrlOutput$
];
export var GetJobRun$: StaticOperationSchema = [9, n0, _GJR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/jobRuns/{identifier}", 200] }, () => GetJobRunInput$, () => GetJobRunOutput$
];
export var GetLineageEvent$: StaticOperationSchema = [9, n0, _GLE,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/lineage/events/{identifier}", 200] }, () => GetLineageEventInput$, () => GetLineageEventOutput$
];
export var GetLineageNode$: StaticOperationSchema = [9, n0, _GLN,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/lineage/nodes/{identifier}", 200] }, () => GetLineageNodeInput$, () => GetLineageNodeOutput$
];
export var GetListing$: StaticOperationSchema = [9, n0, _GL,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/listings/{identifier}", 200] }, () => GetListingInput$, () => GetListingOutput$
];
...
export var GetSubscription$: StaticOperationSchema = [9, n0, _GS,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscriptions/{identifier}", 200] }, () => GetSubscriptionInput$, () => GetSubscriptionOutput$
];
export var GetSubscriptionGrant$: StaticOperationSchema = [9, n0, _GSG,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscription-grants/{identifier}", 200] }, () => GetSubscriptionGrantInput$, () => GetSubscriptionGrantOutput$
];
export var GetSubscriptionRequestDetails$: StaticOperationSchema = [9, n0, _GSRD,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscription-requests/{identifier}", 200] }, () => GetSubscriptionRequestDetailsInput$, () => GetSubscriptionRequestDetailsOutput$
];
export var GetSubscriptionTarget$: StaticOperationSchema = [9, n0, _GSTe,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/subscription-targets/{identifier}", 200] }, () => GetSubscriptionTargetInput$, () => GetSubscriptionTargetOutput$
];
export var GetTimeSeriesDataPoint$: StaticOperationSchema = [9, n0, _GTSDP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/time-series-data-points/{identifier}", 200] }, () => GetTimeSeriesDataPointInput$, () => GetTimeSeriesDataPointOutput$
];
export var GetUserProfile$: StaticOperationSchema = [9, n0, _GUP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/user-profiles/{userIdentifier}", 200] }, () => GetUserProfileInput$, () => GetUserProfileOutput$
];
export var ListAccountPools$: StaticOperationSchema = [9, n0, _LAP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/account-pools", 200] }, () => ListAccountPoolsInput$, () => ListAccountPoolsOutput$
];
export var ListAccountsInAccountPool$: StaticOperationSchema = [9, n0, _LAIAP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/account-pools/{identifier}/accounts", 200] }, () => ListAccountsInAccountPoolInput$, () => ListAccountsInAccountPoolOutput$
];
export var ListAssetFilters$: StaticOperationSchema = [9, n0, _LAF,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/assets/{assetIdentifier}/filters", 200] }, () => ListAssetFiltersInput$, () => ListAssetFiltersOutput$
];
export var ListAssetRevisions$: StaticOperationSchema = [9, n0, _LAR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/assets/{identifier}/revisions", 200] }, () => ListAssetRevisionsInput$, () => ListAssetRevisionsOutput$
];
export var ListConnections$: StaticOperationSchema = [9, n0, _LC,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/connections", 200] }, () => ListConnectionsInput$, () => ListConnectionsOutput$
];
export var ListDataProductRevisions$: StaticOperationSchema = [9, n0, _LDPR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-products/{identifier}/revisions", 200] }, () => ListDataProductRevisionsInput$, () => ListDataProductRevisionsOutput$
];
export var ListDataSourceRunActivities$: StaticOperationSchema = [9, n0, _LDSRA,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-source-runs/{identifier}/activities", 200] }, () => ListDataSourceRunActivitiesInput$, () => ListDataSourceRunActivitiesOutput$
];
export var ListDataSourceRuns$: StaticOperationSchema = [9, n0, _LDSR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-sources/{dataSourceIdentifier}/runs", 200] }, () => ListDataSourceRunsInput$, () => ListDataSourceRunsOutput$
];
export var ListDataSources$: StaticOperationSchema = [9, n0, _LDS,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/data-sources", 200] }, () => ListDataSourcesInput$, () => ListDataSourcesOutput$
];
export var ListDomains$: StaticOperationSchema = [9, n0, _LDi,
  { [_ht]: ["GET", "/v2/domains", 200] }, () => ListDomainsInput$, () => ListDomainsOutput$
];
export var ListDomainUnitsForParent$: StaticOperationSchema = [9, n0, _LDUFP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/domain-units", 200] }, () => ListDomainUnitsForParentInput$, () => ListDomainUnitsForParentOutput$
];
export var ListEntityOwners$: StaticOperationSchema = [9, n0, _LEOi,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/owners", 200] }, () => ListEntityOwnersInput$, () => ListEntityOwnersOutput$
];
export var ListEnvironmentActions$: StaticOperationSchema = [9, n0, _LEA,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/actions", 200] }, () => ListEnvironmentActionsInput$, () => ListEnvironmentActionsOutput$
];
export var ListEnvironmentBlueprintConfigurations$: StaticOperationSchema = [9, n0, _LEBC,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-blueprint-configurations", 200] }, () => ListEnvironmentBlueprintConfigurationsInput$, () => ListEnvironmentBlueprintConfigurationsOutput$
];
export var ListEnvironmentBlueprints$: StaticOperationSchema = [9, n0, _LEB,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-blueprints", 200] }, () => ListEnvironmentBlueprintsInput$, () => ListEnvironmentBlueprintsOutput$
];
export var ListEnvironmentProfiles$: StaticOperationSchema = [9, n0, _LEP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environment-profiles", 200] }, () => ListEnvironmentProfilesInput$, () => ListEnvironmentProfilesOutput$
];
export var ListEnvironments$: StaticOperationSchema = [9, n0, _LEis,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments", 200] }, () => ListEnvironmentsInput$, () => ListEnvironmentsOutput$
];
export var ListJobRuns$: StaticOperationSchema = [9, n0, _LJR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/jobs/{jobIdentifier}/runs", 200] }, () => ListJobRunsInput$, () => ListJobRunsOutput$
];
export var ListLineageEvents$: StaticOperationSchema = [9, n0, _LLE,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/lineage/events", 200] }, () => ListLineageEventsInput$, () => ListLineageEventsOutput$
];
export var ListLineageNodeHistory$: StaticOperationSchema = [9, n0, _LLNH,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/lineage/nodes/{identifier}/history", 200] }, () => ListLineageNodeHistoryInput$, () => ListLineageNodeHistoryOutput$
];
export var ListMetadataGenerationRuns$: StaticOperationSchema = [9, n0, _LMGR,
...
export var ListPolicyGrants$: StaticOperationSchema = [9, n0, _LPG,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/policies/managed/{entityType}/{entityIdentifier}/grants", 200] }, () => ListPolicyGrantsInput$, () => ListPolicyGrantsOutput$
];
...
export var ListProjects$: StaticOperationSchema = [9, n0, _LP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/projects", 200] }, () => ListProjectsInput$, () => ListProjectsOutput$
];
export var ListRules$: StaticOperationSchema = [9, n0, _LRi,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/list-rules/{targetType}/{targetIdentifier}", 200] }, () => ListRulesInput$, () => ListRulesOutput$
];
export var ListSubscriptionGrants$: StaticOperationSchema = [9, n0, _LSG,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscription-grants", 200] }, () => ListSubscriptionGrantsInput$, () => ListSubscriptionGrantsOutput$
];
export var ListSubscriptionRequests$: StaticOperationSchema = [9, n0, _LSR,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscription-requests", 200] }, () => ListSubscriptionRequestsInput$, () => ListSubscriptionRequestsOutput$
];
export var ListSubscriptions$: StaticOperationSchema = [9, n0, _LSis,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/subscriptions", 200] }, () => ListSubscriptionsInput$, () => ListSubscriptionsOutput$
];
export var ListSubscriptionTargets$: StaticOperationSchema = [9, n0, _LST,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/subscription-targets", 200] }, () => ListSubscriptionTargetsInput$, () => ListSubscriptionTargetsOutput$
];
export var ListTagsForResource$: StaticOperationSchema = [9, n0, _LTFR,
  { [_ht]: ["GET", "/tags/{resourceArn}", 200] }, () => ListTagsForResourceRequest$, () => ListTagsForResourceResponse$
];
export var ListTimeSeriesDataPoints$: StaticOperationSchema = [9, n0, _LTSDP,
  { [_ht]: ["GET", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/time-series-data-points", 200] }, () => ListTimeSeriesDataPointsInput$, () => ListTimeSeriesDataPointsOutput$
];
export var PostLineageEvent$: StaticOperationSchema = [9, n0, _PLE,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/lineage/events", 200] }, () => PostLineageEventInput$, () => PostLineageEventOutput$
];
export var PostTimeSeriesDataPoints$: StaticOperationSchema = [9, n0, _PTSDP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/time-series-data-points", 201] }, () => PostTimeSeriesDataPointsInput$, () => PostTimeSeriesDataPointsOutput$
];
export var PutDataExportConfiguration$: StaticOperationSchema = [9, n0, _PDEC,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/data-export-configuration", 200] }, () => PutDataExportConfigurationInput$, () => PutDataExportConfigurationOutput$
];
...
export var RejectSubscriptionRequest$: StaticOperationSchema = [9, n0, _RSR,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/subscription-requests/{identifier}/reject", 200] }, () => RejectSubscriptionRequestInput$, () => RejectSubscriptionRequestOutput$
];
export var RemoveEntityOwner$: StaticOperationSchema = [9, n0, _REO,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/entities/{entityType}/{entityIdentifier}/removeOwner", 204] }, () => RemoveEntityOwnerInput$, () => RemoveEntityOwnerOutput$
];
export var RemovePolicyGrant$: StaticOperationSchema = [9, n0, _RPG,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/policies/managed/{entityType}/{entityIdentifier}/removeGrant", 204] }, () => RemovePolicyGrantInput$, () => RemovePolicyGrantOutput$
];
export var RevokeSubscription$: StaticOperationSchema = [9, n0, _RSev,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/subscriptions/{identifier}/revoke", 200] }, () => RevokeSubscriptionInput$, () => RevokeSubscriptionOutput$
];
export var Search$: StaticOperationSchema = [9, n0, _Se,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/search", 200] }, () => SearchInput$, () => SearchOutput$
];
export var SearchGroupProfiles$: StaticOperationSchema = [9, n0, _SGP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/search-group-profiles", 200] }, () => SearchGroupProfilesInput$, () => SearchGroupProfilesOutput$
];
export var SearchListings$: StaticOperationSchema = [9, n0, _SLe,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/listings/search", 200] }, () => SearchListingsInput$, () => SearchListingsOutput$
];
export var SearchTypes$: StaticOperationSchema = [9, n0, _STe,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/types-search", 200] }, () => SearchTypesInput$, () => SearchTypesOutput$
];
export var SearchUserProfiles$: StaticOperationSchema = [9, n0, _SUP,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/search-user-profiles", 200] }, () => SearchUserProfilesInput$, () => SearchUserProfilesOutput$
];
export var StartDataSourceRun$: StaticOperationSchema = [9, n0, _SDSR,
  { [_ht]: ["POST", "/v2/domains/{domainIdentifier}/data-sources/{dataSourceIdentifier}/runs", 200] }, () => StartDataSourceRunInput$, () => StartDataSourceRunOutput$
];
...
export var UpdateAccountPool$: StaticOperationSchema = [9, n0, _UAP,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/account-pools/{identifier}", 200] }, () => UpdateAccountPoolInput$, () => UpdateAccountPoolOutput$
];
export var UpdateAssetFilter$: StaticOperationSchema = [9, n0, _UAF,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/assets/{assetIdentifier}/filters/{identifier}", 200] }, () => UpdateAssetFilterInput$, () => UpdateAssetFilterOutput$
];
export var UpdateConnection$: StaticOperationSchema = [9, n0, _UC,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/connections/{identifier}", 200] }, () => UpdateConnectionInput$, () => UpdateConnectionOutput$
];
export var UpdateDataSource$: StaticOperationSchema = [9, n0, _UDS,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/data-sources/{identifier}", 200] }, () => UpdateDataSourceInput$, () => UpdateDataSourceOutput$
];
export var UpdateDomain$: StaticOperationSchema = [9, n0, _UDp,
  { [_ht]: ["PUT", "/v2/domains/{identifier}", 200] }, () => UpdateDomainInput$, () => UpdateDomainOutput$
];
export var UpdateDomainUnit$: StaticOperationSchema = [9, n0, _UDU,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/domain-units/{identifier}", 200] }, () => UpdateDomainUnitInput$, () => UpdateDomainUnitOutput$
];
export var UpdateEnvironment$: StaticOperationSchema = [9, n0, _UEp,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/environments/{identifier}", 200] }, () => UpdateEnvironmentInput$, () => UpdateEnvironmentOutput$
];
export var UpdateEnvironmentAction$: StaticOperationSchema = [9, n0, _UEA,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/actions/{identifier}", 200] }, () => UpdateEnvironmentActionInput$, () => UpdateEnvironmentActionOutput$
];
export var UpdateEnvironmentBlueprint$: StaticOperationSchema = [9, n0, _UEB,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/environment-blueprints/{identifier}", 200] }, () => UpdateEnvironmentBlueprintInput$, () => UpdateEnvironmentBlueprintOutput$
];
export var UpdateEnvironmentProfile$: StaticOperationSchema = [9, n0, _UEP,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/environment-profiles/{identifier}", 200] }, () => UpdateEnvironmentProfileInput$, () => UpdateEnvironmentProfileOutput$
];
export var UpdateGlossary$: StaticOperationSchema = [9, n0, _UG,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/glossaries/{identifier}", 200] }, () => UpdateGlossaryInput$, () => UpdateGlossaryOutput$
];
export var UpdateGlossaryTerm$: StaticOperationSchema = [9, n0, _UGT,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/glossary-terms/{identifier}", 200] }, () => UpdateGlossaryTermInput$, () => UpdateGlossaryTermOutput$
];
...
export var UpdateProjectProfile$: StaticOperationSchema = [9, n0, _UPP,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/project-profiles/{identifier}", 200] }, () => UpdateProjectProfileInput$, () => UpdateProjectProfileOutput$
];
export var UpdateRootDomainUnitOwner$: StaticOperationSchema = [9, n0, _URDUO,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/root-domain-unit-owner", 204] }, () => UpdateRootDomainUnitOwnerInput$, () => UpdateRootDomainUnitOwnerOutput$
];
export var UpdateRule$: StaticOperationSchema = [9, n0, _URp,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/rules/{identifier}", 200] }, () => UpdateRuleInput$, () => UpdateRuleOutput$
];
export var UpdateSubscriptionGrantStatus$: StaticOperationSchema = [9, n0, _USGS,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/subscription-grants/{identifier}/status/{assetIdentifier}", 200] }, () => UpdateSubscriptionGrantStatusInput$, () => UpdateSubscriptionGrantStatusOutput$
];
export var UpdateSubscriptionRequest$: StaticOperationSchema = [9, n0, _USR,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/subscription-requests/{identifier}", 200] }, () => UpdateSubscriptionRequestInput$, () => UpdateSubscriptionRequestOutput$
];
export var UpdateSubscriptionTarget$: StaticOperationSchema = [9, n0, _USTp,
  { [_ht]: ["PATCH", "/v2/domains/{domainIdentifier}/environments/{environmentIdentifier}/subscription-targets/{identifier}", 200] }, () => UpdateSubscriptionTargetInput$, () => UpdateSubscriptionTargetOutput$
];
export var UpdateUserProfile$: StaticOperationSchema = [9, n0, _UUP,
  { [_ht]: ["PUT", "/v2/domains/{domainIdentifier}/user-profiles/{userIdentifier}", 200] }, () => UpdateUserProfileInput$, () => UpdateUserProfileOutput$
];
