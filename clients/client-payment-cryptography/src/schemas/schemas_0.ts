...
export var KeyModesOfUse$: StaticStructureSchema = [3, n0, _KMOU,
  0,
...
var KeySummaryList: StaticListSchema = [1, n0, _KSL,
  0, () => KeySummary$
];
var Regions = 64 | 0;
var TagKeys = 64 | 0;
...
var OptionalBlocks: StaticMapSchema = [2, n0, _OB,
  0, [() => OptionalBlockId,
    0]
  , [() => OptionalBlockValue,
    0]
];
var ReplicationStatus: StaticMapSchema = [2, n0, _RS,
...
export var ExportKeyMaterial$: StaticUnionSchema = [4, n0, _EKM,
  0,
...
export var ImportKeyMaterial$: StaticUnionSchema = [4, n0, _IKM,
  0,
...
export var ExportKey$: StaticOperationSchema = [9, n0, _EK,
  0, () => ExportKeyInput$, () => ExportKeyOutput$
];
export var GetAlias$: StaticOperationSchema = [9, n0, _GA,
  0, () => GetAliasInput$, () => GetAliasOutput$
];
export var GetCertificateSigningRequest$: StaticOperationSchema = [9, n0, _GCSR,
  0, () => GetCertificateSigningRequestInput$, () => GetCertificateSigningRequestOutput$
];
export var GetDefaultKeyReplicationRegions$: StaticOperationSchema = [9, n0, _GDKRR,
...
export var RestoreKey$: StaticOperationSchema = [9, n0, _RK,
  0, () => RestoreKeyInput$, () => RestoreKeyOutput$
];
export var StartKeyUsage$: StaticOperationSchema = [9, n0, _SKU,
  0, () => StartKeyUsageInput$, () => StartKeyUsageOutput$
];
export var StopKeyUsage$: StaticOperationSchema = [9, n0, _SKUt,
