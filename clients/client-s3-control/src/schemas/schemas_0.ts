...
export var AsyncOperation$: StaticStructureSchema = [3, n0, _AO,
  0,
  [_CT, _Op, _RTARN, _RP, _RS, _RD],
  [4, 0, 0, [() => AsyncRequestParameters$, 0], 0, [() => AsyncResponseDetails$, 0]]
];
export var AsyncRequestParameters$: StaticStructureSchema = [3, n0, _ARP,
  0,
...
export var AsyncResponseDetails$: StaticStructureSchema = [3, n0, _ARD,
  0,
  [_MRAPD, _ED],
...
export var CreateAccessGrantsInstanceRequest$: StaticStructureSchema = [3, n0, _CAGIR,
  0,
  [_AI, _ICA, _T],
  [[0, { [_hL]: 1, [_hH]: _xaai }], 0, [() => TagList, 0]]
];
export var CreateAccessGrantsInstanceResult$: StaticStructureSchema = [3, n0, _CAGIRr,
  0,
...
export var DeleteAccessGrantsInstanceResourcePolicyRequest$: StaticStructureSchema = [3, n0, _DAGIRPR,
  0,
  [_AI],
  [[0, { [_hL]: 1, [_hH]: _xaai }]]
];
...
export var DSSEKMSFilter$: StaticStructureSchema = [3, n0, _DSSEKMSF,
  0,
  [_KKA],
  [0]
];
...
export var EstablishedMultiRegionAccessPointPolicy$: StaticStructureSchema = [3, n0, _EMRAPP,
  0,
  [_Po],
  [0]
];
export var _Exclude$: StaticStructureSchema = [3, n0, _Ex,
  0,
  [_Bu, _Reg],
  [[() => Buckets, 0], [() => Regions, 0]]
];
...
export var GetAccessGrantsInstanceRequest$: StaticStructureSchema = [3, n0, _GAGIR,
  0,
  [_AI],
  [[0, { [_hL]: 1, [_hH]: _xaai }]]
];
...
export var GetAccessGrantsInstanceResourcePolicyResult$: StaticStructureSchema = [3, n0, _GAGIRPRe,
  0,
  [_Po, _Or, _CA],
  [0, 0, 4]
];
export var GetAccessGrantsInstanceResult$: StaticStructureSchema = [3, n0, _GAGIRe,
  0,
...
export var Grantee$: StaticStructureSchema = [3, n0, _G,
  0,
  [_GT, _GI],
  [0, 0]
];
...
export var JobListDescriptor$: StaticStructureSchema = [3, n0, _JLD,
  0,
...
export var KeyNameConstraint$: StaticStructureSchema = [3, n0, _KNC,
  0,
  [_MAP, _MAS, _MASa],
  [64 | 0, 64 | 0, 64 | 0]
];
export var LambdaInvokeOperation$: StaticStructureSchema = [3, n0, _LIO,
  0,
  [_FA, _ISV, _UA],
  [0, 0, 128 | 0]
];
export var LifecycleConfiguration$: StaticStructureSchema = [3, n0, _LCi,
  0,
  [_Ru],
  [[() => LifecycleRules, 0]]
];
export var LifecycleExpiration$: StaticStructureSchema = [3, n0, _LE,
  0,
  [_Da, _Day, _EODM],
  [4, 1, 2]
];
...
export var ListAccessGrantEntry$: StaticStructureSchema = [3, n0, _LAGE,
  0,
  [_CA, _AGI, _AGA, _G, _P, _AGLI, _AGLC, _GS, _AA],
  [4, 0, 0, () => Grantee$, 0, 0, () => AccessGrantsLocationConfiguration$, 0, 0]
];
export var ListAccessGrantsInstanceEntry$: StaticStructureSchema = [3, n0, _LAGIE,
  0,
  [_AGII, _AGIA, _CA, _ICA, _ICIA, _ICAA],
  [0, 0, 4, 0, 0, 0]
];
export var ListAccessGrantsInstancesRequest$: StaticStructureSchema = [3, n0, _LAGIR,
  0,
  [_AI, _NT, _MR],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListAccessGrantsInstancesResult$: StaticStructureSchema = [3, n0, _LAGIRi,
  0,
  [_NT, _AGIL],
  [0, [() => AccessGrantsInstancesList, 0]]
];
export var ListAccessGrantsLocationsEntry$: StaticStructureSchema = [3, n0, _LAGLE,
  0,
  [_CA, _AGLI, _AGLA, _LS, _IAMRA],
  [4, 0, 0, 0, 0]
];
export var ListAccessGrantsLocationsRequest$: StaticStructureSchema = [3, n0, _LAGLR,
  0,
  [_AI, _NT, _MR, _LS],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _l }]]
];
export var ListAccessGrantsLocationsResult$: StaticStructureSchema = [3, n0, _LAGLRi,
  0,
  [_NT, _AGLL],
  [0, [() => AccessGrantsLocationsList, 0]]
];
export var ListAccessGrantsRequest$: StaticStructureSchema = [3, n0, _LAGR,
  0,
  [_AI, _NT, _MR, _GT, _GI, _P, _GS, _AA],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _g }], [0, { [_hQ]: _gr }], [0, { [_hQ]: _p }], [0, { [_hQ]: _gra }], [0, { [_hQ]: _aa }]]
];
export var ListAccessGrantsResult$: StaticStructureSchema = [3, n0, _LAGRi,
  0,
  [_NT, _AGL],
  [0, [() => AccessGrantsList, 0]]
];
export var ListAccessPointsForDirectoryBucketsRequest$: StaticStructureSchema = [3, n0, _LAPFDBR,
  0,
  [_AI, _DB, _NT, _MR],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _dB }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListAccessPointsForDirectoryBucketsResult$: StaticStructureSchema = [3, n0, _LAPFDBRi,
  0,
  [_APL, _NT],
  [[() => AccessPointList, 0], 0]
];
export var ListAccessPointsForObjectLambdaRequest$: StaticStructureSchema = [3, n0, _LAPFOLR,
  0,
  [_AI, _NT, _MR],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListAccessPointsForObjectLambdaResult$: StaticStructureSchema = [3, n0, _LAPFOLRi,
  0,
  [_OLAPL, _NT],
...
export var ListAccessPointsResult$: StaticStructureSchema = [3, n0, _LAPRi,
  0,
  [_APL, _NT],
  [[() => AccessPointList, 0], 0]
];
export var ListCallerAccessGrantsEntry$: StaticStructureSchema = [3, n0, _LCAGE,
  0,
  [_P, _GS, _AA],
  [0, 0, 0]
];
export var ListCallerAccessGrantsRequest$: StaticStructureSchema = [3, n0, _LCAGR,
  0,
  [_AI, _GS, _NT, _MR, _ABA],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _gra }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [2, { [_hQ]: _aBA }]]
];
export var ListCallerAccessGrantsResult$: StaticStructureSchema = [3, n0, _LCAGRi,
  0,
  [_NT, _CAGL],
...
export var ListMultiRegionAccessPointsRequest$: StaticStructureSchema = [3, n0, _LMRAPR,
  0,
  [_AI, _NT, _MR],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListMultiRegionAccessPointsResult$: StaticStructureSchema = [3, n0, _LMRAPRi,
  0,
  [_APc, _NT],
  [[() => MultiRegionAccessPointReportList, 0], 0]
];
export var ListRegionalBucketsRequest$: StaticStructureSchema = [3, n0, _LRBR,
  0,
  [_AI, _NT, _MR, _OI],
  [[0, { [_hL]: 1, [_hH]: _xaai }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hH]: _xaoi }]]
];
export var ListRegionalBucketsResult$: StaticStructureSchema = [3, n0, _LRBRi,
  0,
  [_RBL, _NT],
...
export var ListStorageLensConfigurationsResult$: StaticStructureSchema = [3, n0, _LSLCRi,
  { [_xN]: _LSLCRis },
  [_NT, _SLCL],
...
export var ListStorageLensGroupsResult$: StaticStructureSchema = [3, n0, _LSLGRi,
  0,
  [_NT, _SLGLt],
...
export var MatchObjectAge$: StaticStructureSchema = [3, n0, _MOA,
  0,
  [_DGT, _DLT],
  [1, 1]
];
export var MatchObjectSize$: StaticStructureSchema = [3, n0, _MOS,
  0,
  [_BGT, _BLT],
  [1, 1]
];
...
export var MultiRegionAccessPointRegionalResponse$: StaticStructureSchema = [3, n0, _MRAPRR,
  0,
  [_N, _RS],
  [0, 0]
];
export var MultiRegionAccessPointReport$: StaticStructureSchema = [3, n0, _MRAPR,
  0,
...
export var S3GeneratedManifestDescriptor$: StaticStructureSchema = [3, n0, _SGMD,
  0,
  [_F, _L],
  [0, () => JobManifestLocation$]
];
export var S3Grant$: StaticStructureSchema = [3, n0, _SG,
  0,
  [_G, _P],
  [() => S3Grantee$, 0]
];
export var S3Grantee$: StaticStructureSchema = [3, n0, _SGr,
  0,
  [_TI, _Ide, _DN],
  [0, 0, 0]
];
export var S3InitiateRestoreObjectOperation$: StaticStructureSchema = [3, n0, _SIROO,
  0,
  [_EID, _GJT],
  [1, 0]
];
...
export var S3ObjectOwner$: StaticStructureSchema = [3, n0, _SOO,
  0,
  [_ID, _DN],
  [0, 0]
];
export var S3ReplicateObjectOperation$: StaticStructureSchema = [3, n0, _SROO,
  0,
  [],
  []
];
...
export var SelectionCriteria$: StaticStructureSchema = [3, n0, _SCe,
  0,
  [_Del, _MDa, _MSBP],
  [0, 1, 1]
];
...
export var SSECFilter$: StaticStructureSchema = [3, n0, _SSECF,
  0,
  [],
  []
];
...
export var SSES3Encryption$: StaticStructureSchema = [3, n0, _SSESE,
  { [_xN]: _SS },
  [],
  []
];
export var SSES3Filter$: StaticStructureSchema = [3, n0, _SSESF,
  0,
  [],
  []
];
...
export var StorageLensDataExportEncryption$: StaticStructureSchema = [3, n0, _SLDEE,
  0,
  [_SSES, _SSEKMS],
  [[() => SSES3$, { [_xN]: _SS }], [() => SSEKMS$, { [_xN]: _SK }]]
];
export var StorageLensExpandedPrefixesDataExport$: StaticStructureSchema = [3, n0, _SLEPDE,
  0,
  [_SBD, _SLTD],
...
export var StorageLensGroupFilter$: StaticStructureSchema = [3, n0, _SLGF,
  0,
...
export var StorageLensGroupLevel$: StaticStructureSchema = [3, n0, _SLGL,
  0,
  [_SCe],
  [[() => StorageLensGroupLevelSelectionCriteria$, 0]]
];
export var StorageLensGroupLevelSelectionCriteria$: StaticStructureSchema = [3, n0, _SLGLSC,
  0,
  [_I, _Ex],
  [[() => StorageLensGroupLevelInclude, 0], [() => StorageLensGroupLevelExclude, 0]]
];
export var StorageLensGroupOrOperator$: StaticStructureSchema = [3, n0, _SLGOO,
  0,
  [_MAP, _MAS, _MAT, _MOA, _MOS],
  [[() => MatchAnyPrefix, 0], [() => MatchAnySuffix, 0], [() => MatchAnyTag, 0], () => MatchObjectAge$, () => MatchObjectSize$]
];
...
var AccessGrantsList: StaticListSchema = [1, n0, _AGL,
  0, [() => ListAccessGrantEntry$,
    { [_xN]: _AG }]
];
var AccessGrantsLocationsList: StaticListSchema = [1, n0, _AGLL,
...
var CallerAccessGrantsList: StaticListSchema = [1, n0, _CAGL,
  0, [() => ListCallerAccessGrantsEntry$,
    { [_xN]: _AG }]
];
var JobFailureList: StaticListSchema = [1, n0, _JFL,
  0, () => JobFailure$
];
var JobListDescriptorList: StaticListSchema = [1, n0, _JLDL,
  0, () => JobListDescriptor$
];
...
var MatchAnyPrefix: StaticListSchema = [1, n0, _MAP,
  0, [0,
    { [_xN]: _Pre }]
];
var MatchAnySuffix: StaticListSchema = [1, n0, _MAS,
  0, [0,
    { [_xN]: _Su }]
];
var MatchAnyTag: StaticListSchema = [1, n0, _MAT,
  0, [() => S3Tag$,
    { [_xN]: _Tag }]
];
var MultiRegionAccessPointRegionalResponseList: StaticListSchema = [1, n0, _MRAPRRL,
  0, [() => MultiRegionAccessPointRegionalResponse$,
    { [_xN]: _Regi }]
];
var MultiRegionAccessPointReportList: StaticListSchema = [1, n0, _MRAPRL,
...
var ObjectEncryptionFilterList: StaticListSchema = [1, n0, _OEFL,
  0, [() => ObjectEncryptionFilter$,
    { [_xN]: _OE }]
];
var ObjectLambdaAccessPointList: StaticListSchema = [1, n0, _OLAPL,
  0, [() => ObjectLambdaAccessPoint$,
    { [_xN]: _OLAP }]
];
var ObjectLambdaAllowedFeaturesList: StaticListSchema = [1, n0, _OLAFL,
  0, [0,
    { [_xN]: _AFl }]
];
var ObjectLambdaTransformationConfigurationActionsList: StaticListSchema = [1, n0, _OLTCAL,
  0, [0,
    { [_xN]: _Acti }]
];
var ObjectLambdaTransformationConfigurationsList: StaticListSchema = [1, n0, _OLTCL,
  0, [() => ObjectLambdaTransformationConfiguration$,
    { [_xN]: _TCr }]
];
var PrefixesList: StaticListSchema = [1, n0, _PLr,
  0, [0,
    { [_xN]: _Pre }]
];
var RegionalBucketList: StaticListSchema = [1, n0, _RBL,
  0, [() => RegionalBucket$,
    { [_xN]: _RB }]
];
var RegionCreationList: StaticListSchema = [1, n0, _RCL,
  0, [() => Region$,
    { [_xN]: _Regi }]
];
var RegionReportList: StaticListSchema = [1, n0, _RRL,
  0, [() => RegionReport$,
    { [_xN]: _Regi }]
];
var Regions: StaticListSchema = [1, n0, _Reg,
  0, [0,
    { [_xN]: _Regi }]
];
...
var S3GrantList: StaticListSchema = [1, n0, _SGL,
  0, () => S3Grant$
];
var S3TagSet: StaticListSchema = [1, n0, _STS,
  0, () => S3Tag$
];
var ScopePermissionList: StaticListSchema = [1, n0, _SPL,
  0, [0,
    { [_xN]: _P }]
];
var StorageClassList = 64 | 0;
var StorageLensConfigurationList: StaticListSchema = [1, n0, _SLCL,
  0, [() => ListStorageLensConfigurationEntry$,
    { [_xN]: _SLC }]
];
var StorageLensGroupLevelExclude: StaticListSchema = [1, n0, _SLGLE,
  0, [0,
    { [_xN]: _Ar }]
];
var StorageLensGroupLevelInclude: StaticListSchema = [1, n0, _SLGLI,
  0, [0,
    { [_xN]: _Ar }]
];
var StorageLensGroupList: StaticListSchema = [1, n0, _SLGLt,
  0, [() => ListStorageLensGroupEntry$,
    { [_xN]: _SLG }]
];
var StorageLensTags: StaticListSchema = [1, n0, _SLTt,
  0, [() => StorageLensTag$,
    { [_xN]: _Tag }]
];
var TagKeyList = 64 | 0;
...
export var JobManifestGenerator$: StaticUnionSchema = [4, n0, _JMG,
  0,
  [_SJMG],
  [[() => S3JobManifestGenerator$, 0]]
];
export var ObjectEncryptionFilter$: StaticUnionSchema = [4, n0, _OEF,
  0,
...
export var ObjectLambdaContentTransformation$: StaticUnionSchema = [4, n0, _OLCT,
  0,
  [_ALw],
  [() => AwsLambdaTransformation$]
];
export var AssociateAccessGrantsIdentityCenter$: StaticOperationSchema = [9, n0, _AAGIC,
  { [_h]: ["POST", "/v20180820/accessgrantsinstance/identitycenter", 200], [_hCR]: 1 }, () => AssociateAccessGrantsIdentityCenterRequest$, () => __Unit
];
export var CreateAccessGrant$: StaticOperationSchema = [9, n0, _CAG,
  { [_h]: ["POST", "/v20180820/accessgrantsinstance/grant", 200], [_hCR]: 1 }, () => CreateAccessGrantRequest$, () => CreateAccessGrantResult$
];
export var CreateAccessGrantsInstance$: StaticOperationSchema = [9, n0, _CAGI,
  { [_h]: ["POST", "/v20180820/accessgrantsinstance", 200], [_hCR]: 1 }, () => CreateAccessGrantsInstanceRequest$, () => CreateAccessGrantsInstanceResult$
];
export var CreateAccessGrantsLocation$: StaticOperationSchema = [9, n0, _CAGLr,
...
export var CreateAccessPointForObjectLambda$: StaticOperationSchema = [9, n0, _CAPFOL,
...
export var CreateMultiRegionAccessPoint$: StaticOperationSchema = [9, n0, _CMRAP,
...
export var CreateStorageLensGroup$: StaticOperationSchema = [9, n0, _CSLG,
  { [_h]: ["POST", "/v20180820/storagelensgroup", 204] }, () => CreateStorageLensGroupRequest$, () => __Unit
];
export var DeleteAccessGrant$: StaticOperationSchema = [9, n0, _DAG,
  { [_h]: ["DELETE", "/v20180820/accessgrantsinstance/grant/{AccessGrantId}", 200], [_hCR]: 1 }, () => DeleteAccessGrantRequest$, () => __Unit
];
export var DeleteAccessGrantsInstance$: StaticOperationSchema = [9, n0, _DAGI,
  { [_h]: ["DELETE", "/v20180820/accessgrantsinstance", 200], [_hCR]: 1 }, () => DeleteAccessGrantsInstanceRequest$, () => __Unit
];
export var DeleteAccessGrantsInstanceResourcePolicy$: StaticOperationSchema = [9, n0, _DAGIRP,
...
export var DeleteAccessGrantsLocation$: StaticOperationSchema = [9, n0, _DAGL,
...
export var DeleteBucketLifecycleConfiguration$: StaticOperationSchema = [9, n0, _DBLC,
...
export var DeleteJobTagging$: StaticOperationSchema = [9, n0, _DJT,
  { [_h]: ["DELETE", "/v20180820/jobs/{JobId}/tagging", 200] }, () => DeleteJobTaggingRequest$, () => DeleteJobTaggingResult$
];
export var DeleteMultiRegionAccessPoint$: StaticOperationSchema = [9, n0, _DMRAP,
...
export var DeleteStorageLensConfiguration$: StaticOperationSchema = [9, n0, _DSLC,
  { [_h]: ["DELETE", "/v20180820/storagelens/{ConfigId}", 200] }, () => DeleteStorageLensConfigurationRequest$, () => __Unit
];
export var DeleteStorageLensConfigurationTagging$: StaticOperationSchema = [9, n0, _DSLCT,
...
export var DeleteStorageLensGroup$: StaticOperationSchema = [9, n0, _DSLG,
...
export var DescribeMultiRegionAccessPointOperation$: StaticOperationSchema = [9, n0, _DMRAPO,
...
export var GetAccessGrantsInstanceResourcePolicy$: StaticOperationSchema = [9, n0, _GAGIRP,
...
export var GetAccessGrantsLocation$: StaticOperationSchema = [9, n0, _GAGL,
...
export var GetAccessPointConfigurationForObjectLambda$: StaticOperationSchema = [9, n0, _GAPCFOL,
...
export var GetAccessPointForObjectLambda$: StaticOperationSchema = [9, n0, _GAPFOL,
...
export var GetAccessPointPolicy$: StaticOperationSchema = [9, n0, _GAPP,
  { [_h]: ["GET", "/v20180820/accesspoint/{Name}/policy", 200] }, () => GetAccessPointPolicyRequest$, () => GetAccessPointPolicyResult$
];
export var GetAccessPointPolicyForObjectLambda$: StaticOperationSchema = [9, n0, _GAPPFOL,
...
export var GetAccessPointPolicyStatus$: StaticOperationSchema = [9, n0, _GAPPS,
  { [_h]: ["GET", "/v20180820/accesspoint/{Name}/policyStatus", 200] }, () => GetAccessPointPolicyStatusRequest$, () => GetAccessPointPolicyStatusResult$
];
export var GetAccessPointPolicyStatusForObjectLambda$: StaticOperationSchema = [9, n0, _GAPPSFOL,
...
export var GetAccessPointScope$: StaticOperationSchema = [9, n0, _GAPS,
  { [_h]: ["GET", "/v20180820/accesspoint/{Name}/scope", 200] }, () => GetAccessPointScopeRequest$, () => GetAccessPointScopeResult$
];
export var GetBucket$: StaticOperationSchema = [9, n0, _GB,
...
export var GetBucketReplication$: StaticOperationSchema = [9, n0, _GBRet,
...
export var GetMultiRegionAccessPointPolicyStatus$: StaticOperationSchema = [9, n0, _GMRAPPS,
...
export var GetMultiRegionAccessPointRoutes$: StaticOperationSchema = [9, n0, _GMRAPRet,
...
export var GetStorageLensConfiguration$: StaticOperationSchema = [9, n0, _GSLC,
  { [_h]: ["GET", "/v20180820/storagelens/{ConfigId}", 200] }, () => GetStorageLensConfigurationRequest$, () => GetStorageLensConfigurationResult$
];
export var GetStorageLensConfigurationTagging$: StaticOperationSchema = [9, n0, _GSLCT,
...
export var ListAccessPointsForDirectoryBuckets$: StaticOperationSchema = [9, n0, _LAPFDB,
...
export var ListAccessPointsForObjectLambda$: StaticOperationSchema = [9, n0, _LAPFOL,
...
export var ListCallerAccessGrants$: StaticOperationSchema = [9, n0, _LCAG,
...
export var PutAccessGrantsInstanceResourcePolicy$: StaticOperationSchema = [9, n0, _PAGIRP,
...
export var PutAccessPointConfigurationForObjectLambda$: StaticOperationSchema = [9, n0, _PAPCFOL,
...
export var PutAccessPointPolicy$: StaticOperationSchema = [9, n0, _PAPP,
  { [_h]: ["PUT", "/v20180820/accesspoint/{Name}/policy", 200] }, () => PutAccessPointPolicyRequest$, () => __Unit
];
export var PutAccessPointPolicyForObjectLambda$: StaticOperationSchema = [9, n0, _PAPPFOL,
  { [_h]: ["PUT", "/v20180820/accesspointforobjectlambda/{Name}/policy", 200] }, () => PutAccessPointPolicyForObjectLambdaRequest$, () => __Unit
];
export var PutAccessPointScope$: StaticOperationSchema = [9, n0, _PAPS,
...
export var PutJobTagging$: StaticOperationSchema = [9, n0, _PJT,
  { [_h]: ["PUT", "/v20180820/jobs/{JobId}/tagging", 200] }, () => PutJobTaggingRequest$, () => PutJobTaggingResult$
];
export var PutMultiRegionAccessPointPolicy$: StaticOperationSchema = [9, n0, _PMRAPPu,
...
export var PutStorageLensConfiguration$: StaticOperationSchema = [9, n0, _PSLC,
  { [_h]: ["PUT", "/v20180820/storagelens/{ConfigId}", 200] }, () => PutStorageLensConfigurationRequest$, () => __Unit
];
export var PutStorageLensConfigurationTagging$: StaticOperationSchema = [9, n0, _PSLCT,
...
export var SubmitMultiRegionAccessPointRoutes$: StaticOperationSchema = [9, n0, _SMRAPR,
...
export var UpdateAccessGrantsLocation$: StaticOperationSchema = [9, n0, _UAGL,
...
export var UpdateJobPriority$: StaticOperationSchema = [9, n0, _UJP,
  { [_h]: ["POST", "/v20180820/jobs/{JobId}/priority", 200] }, () => UpdateJobPriorityRequest$, () => UpdateJobPriorityResult$
];
export var UpdateJobStatus$: StaticOperationSchema = [9, n0, _UJS,
  { [_h]: ["POST", "/v20180820/jobs/{JobId}/status", 200] }, () => UpdateJobStatusRequest$, () => UpdateJobStatusResult$
];
export var UpdateStorageLensGroup$: StaticOperationSchema = [9, n0, _USLG,
